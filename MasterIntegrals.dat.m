{Int[dd[ks[LI[A_]]]*e[Scalar[k[LI[A_], j$_]*(xRel_)[C__, -(j$_)]]]*
    prop[ks[LI[A_]]^2]] -> (Gamma[-1 + d/2]*Scalar[xRel[C, -j$]*xRel[C, j$]]^
     (1 - d/2))/(4*Pi^(d/2)), 
 Int[dd[ks[LI[A_]]]*e[Scalar[k[LI[A_], j$_]*(xRel_)[C__, -(j$_)]]]*
    k[LI[A_], j1$_]*prop[ks[LI[A_]]^2]] -> ((I/2)*Gamma[d/2]*xRel[C, j1$])/
   (Pi^(d/2)*Scalar[xRel[C, -j$]*xRel[C, j$]]^(d/2)), 
 Int[dd[ks[LI[A_]]]*e[Scalar[k[LI[A_], j$_]*(xRel_)[C__, -(j$_)]]]*
    k[LI[A_], j1$_]*k[LI[A_], j2$_]*prop[ks[LI[A_]]^2]] -> 
  (-(Gamma[1 + d/2]*Scalar[xRel[C, -j$]*xRel[C, j$]]^(-1 - d/2)*xRel[C, j1$]*
      xRel[C, j2$]) + (Gamma[d/2]*\[Delta][j1$, j2$])/
     (2*Scalar[xRel[C, -j$]*xRel[C, j$]]^(d/2)))/Pi^(d/2), 
 Int[dd[ks[LI[A_]]]*e[Scalar[k[LI[A_], j$_]*(xRel_)[C__, -(j$_)]]]*
    k[LI[A_], j1$_]*k[LI[A_], j2$_]*k[LI[A_], j3$_]*prop[ks[LI[A_]]^2]] -> 
  ((-2*I)*Gamma[2 + d/2]*Scalar[xRel[C, -j$]*xRel[C, j$]]^(-2 - d/2)*
     xRel[C, j1$]*xRel[C, j2$]*xRel[C, j3$] + I*Gamma[1 + d/2]*
     Scalar[xRel[C, -j$]*xRel[C, j$]]^(-1 - d/2)*
     (xRel[C, j3$]*\[Delta][j1$, j2$] + xRel[C, j2$]*\[Delta][j1$, j3$] + 
      xRel[C, j1$]*\[Delta][j2$, j3$]))/Pi^(d/2), 
 Int[dd[ks[LI[A_]]]*e[Scalar[k[LI[A_], j$_]*(xRel_)[C__, -(j$_)]]]*
    k[LI[A_], j1$_]*k[LI[A_], j2$_]*k[LI[A_], j3$_]*k[LI[A_], j4$_]*
    prop[ks[LI[A_]]^2]] -> 
  (4*Gamma[3 + d/2]*Scalar[xRel[C, -j$]*xRel[C, j$]]^(-3 - d/2)*xRel[C, j1$]*
     xRel[C, j2$]*xRel[C, j3$]*xRel[C, j4$] + 
    Gamma[1 + d/2]*Scalar[xRel[C, -j$]*xRel[C, j$]]^(-1 - d/2)*
     (\[Delta][j1$, j4$]*\[Delta][j2$, j3$] + \[Delta][j1$, j3$]*
       \[Delta][j2$, j4$] + \[Delta][j1$, j2$]*\[Delta][j3$, j4$]) - 
    2*Gamma[2 + d/2]*Scalar[xRel[C, -j$]*xRel[C, j$]]^(-2 - d/2)*
     (xRel[C, j1$]*xRel[C, j4$]*\[Delta][j2$, j3$] + 
      xRel[C, j3$]*(xRel[C, j4$]*\[Delta][j1$, j2$] + 
        xRel[C, j2$]*\[Delta][j1$, j4$] + xRel[C, j1$]*\[Delta][j2$, j4$]) + 
      xRel[C, j2$]*(xRel[C, j4$]*\[Delta][j1$, j3$] + 
        xRel[C, j1$]*\[Delta][j3$, j4$])))/Pi^(d/2), 
 Int[dd[ks[LI[A_]]]*e[Scalar[k[LI[A_], j$_]*(xRel_)[C__, -(j$_)]]]*
    k[LI[A_], j1$_]*k[LI[A_], j2$_]*k[LI[A_], j3$_]*k[LI[A_], j4$_]*
    k[LI[A_], j5$_]*prop[ks[LI[A_]]^2]] -> 
  ((8*I)*Gamma[4 + d/2]*Scalar[xRel[C, -j$]*xRel[C, j$]]^(-4 - d/2)*
     xRel[C, j1$]*xRel[C, j2$]*xRel[C, j3$]*xRel[C, j4$]*xRel[C, j5$] + 
    (2*I)*Gamma[2 + d/2]*Scalar[xRel[C, -j$]*xRel[C, j$]]^(-2 - d/2)*
     (xRel[C, j3$]*\[Delta][j1$, j5$]*\[Delta][j2$, j4$] + 
      xRel[C, j3$]*\[Delta][j1$, j4$]*\[Delta][j2$, j5$] + 
      xRel[C, j2$]*\[Delta][j1$, j5$]*\[Delta][j3$, j4$] + 
      xRel[C, j1$]*\[Delta][j2$, j5$]*\[Delta][j3$, j4$] + 
      xRel[C, j5$]*(\[Delta][j1$, j4$]*\[Delta][j2$, j3$] + 
        \[Delta][j1$, j3$]*\[Delta][j2$, j4$] + \[Delta][j1$, j2$]*
         \[Delta][j3$, j4$]) + xRel[C, j2$]*\[Delta][j1$, j4$]*
       \[Delta][j3$, j5$] + xRel[C, j1$]*\[Delta][j2$, j4$]*
       \[Delta][j3$, j5$] + xRel[C, j4$]*
       (\[Delta][j1$, j5$]*\[Delta][j2$, j3$] + \[Delta][j1$, j3$]*
         \[Delta][j2$, j5$] + \[Delta][j1$, j2$]*\[Delta][j3$, j5$]) + 
      (xRel[C, j3$]*\[Delta][j1$, j2$] + xRel[C, j2$]*\[Delta][j1$, j3$] + 
        xRel[C, j1$]*\[Delta][j2$, j3$])*\[Delta][j4$, j5$]) - 
    (4*I)*Gamma[3 + d/2]*Scalar[xRel[C, -j$]*xRel[C, j$]]^(-3 - d/2)*
     (xRel[C, j1$]*xRel[C, j4$]*xRel[C, j5$]*\[Delta][j2$, j3$] + 
      xRel[C, j2$]*(xRel[C, j5$]*(xRel[C, j4$]*\[Delta][j1$, j3$] + 
          xRel[C, j1$]*\[Delta][j3$, j4$]) + xRel[C, j1$]*xRel[C, j4$]*
         \[Delta][j3$, j5$]) + xRel[C, j3$]*
       (xRel[C, j5$]*(xRel[C, j2$]*\[Delta][j1$, j4$] + 
          xRel[C, j1$]*\[Delta][j2$, j4$]) + xRel[C, j4$]*
         (xRel[C, j5$]*\[Delta][j1$, j2$] + xRel[C, j2$]*\[Delta][j1$, j5$] + 
          xRel[C, j1$]*\[Delta][j2$, j5$]) + xRel[C, j1$]*xRel[C, j2$]*
         \[Delta][j4$, j5$])))/Pi^(d/2), 
 Int[dd[ks[LI[A_]]]*e[Scalar[k[LI[A_], j$_]*(xRel_)[C__, -(j$_)]]]*
    k[LI[A_], j1$_]*k[LI[A_], j2$_]*k[LI[A_], j3$_]*k[LI[A_], j4$_]*
    k[LI[A_], j5$_]*k[LI[A_], j6$_]*prop[ks[LI[A_]]^2]] -> 
  (-16*Gamma[5 + d/2]*Scalar[xRel[C, -j$]*xRel[C, j$]]^(-5 - d/2)*
     xRel[C, j1$]*xRel[C, j2$]*xRel[C, j3$]*xRel[C, j4$]*xRel[C, j5$]*
     xRel[C, j6$] + 2*Gamma[2 + d/2]*Scalar[xRel[C, -j$]*xRel[C, j$]]^
      (-2 - d/2)*(\[Delta][j1$, j4$]*\[Delta][j2$, j6$]*\[Delta][j3$, j5$] + 
      \[Delta][j1$, j4$]*\[Delta][j2$, j5$]*\[Delta][j3$, j6$] + 
      \[Delta][j1$, j3$]*\[Delta][j2$, j6$]*\[Delta][j4$, j5$] + 
      \[Delta][j1$, j2$]*\[Delta][j3$, j6$]*\[Delta][j4$, j5$] + 
      \[Delta][j1$, j6$]*(\[Delta][j2$, j5$]*\[Delta][j3$, j4$] + 
        \[Delta][j2$, j4$]*\[Delta][j3$, j5$] + \[Delta][j2$, j3$]*
         \[Delta][j4$, j5$]) + \[Delta][j1$, j3$]*\[Delta][j2$, j5$]*
       \[Delta][j4$, j6$] + \[Delta][j1$, j2$]*\[Delta][j3$, j5$]*
       \[Delta][j4$, j6$] + \[Delta][j1$, j5$]*
       (\[Delta][j2$, j6$]*\[Delta][j3$, j4$] + \[Delta][j2$, j4$]*
         \[Delta][j3$, j6$] + \[Delta][j2$, j3$]*\[Delta][j4$, j6$]) + 
      (\[Delta][j1$, j4$]*\[Delta][j2$, j3$] + \[Delta][j1$, j3$]*
         \[Delta][j2$, j4$] + \[Delta][j1$, j2$]*\[Delta][j3$, j4$])*
       \[Delta][j5$, j6$]) + 8*Gamma[4 + d/2]*
     Scalar[xRel[C, -j$]*xRel[C, j$]]^(-4 - d/2)*
     (xRel[C, j1$]*xRel[C, j4$]*xRel[C, j5$]*xRel[C, j6$]*
       \[Delta][j2$, j3$] + xRel[C, j2$]*
       (xRel[C, j6$]*(xRel[C, j5$]*(xRel[C, j4$]*\[Delta][j1$, j3$] + 
            xRel[C, j1$]*\[Delta][j3$, j4$]) + xRel[C, j1$]*xRel[C, j4$]*
           \[Delta][j3$, j5$]) + xRel[C, j1$]*xRel[C, j4$]*xRel[C, j5$]*
         \[Delta][j3$, j6$]) + xRel[C, j3$]*
       (xRel[C, j6$]*(xRel[C, j1$]*xRel[C, j5$]*\[Delta][j2$, j4$] + 
          xRel[C, j2$]*(xRel[C, j5$]*\[Delta][j1$, j4$] + 
            xRel[C, j1$]*\[Delta][j4$, j5$])) + xRel[C, j1$]*xRel[C, j2$]*
         xRel[C, j5$]*\[Delta][j4$, j6$] + xRel[C, j4$]*
         (xRel[C, j6$]*(xRel[C, j2$]*\[Delta][j1$, j5$] + 
            xRel[C, j1$]*\[Delta][j2$, j5$]) + xRel[C, j5$]*
           (xRel[C, j6$]*\[Delta][j1$, j2$] + xRel[C, j2$]*\[Delta][j1$, 
              j6$] + xRel[C, j1$]*\[Delta][j2$, j6$]) + 
          xRel[C, j1$]*xRel[C, j2$]*\[Delta][j5$, j6$]))) - 
    4*Gamma[3 + d/2]*Scalar[xRel[C, -j$]*xRel[C, j$]]^(-3 - d/2)*
     (xRel[C, j3$]*xRel[C, j6$]*\[Delta][j1$, j5$]*\[Delta][j2$, j4$] + 
      xRel[C, j3$]*xRel[C, j6$]*\[Delta][j1$, j4$]*\[Delta][j2$, j5$] + 
      xRel[C, j2$]*xRel[C, j6$]*\[Delta][j1$, j5$]*\[Delta][j3$, j4$] + 
      xRel[C, j1$]*xRel[C, j6$]*\[Delta][j2$, j5$]*\[Delta][j3$, j4$] + 
      xRel[C, j2$]*xRel[C, j6$]*\[Delta][j1$, j4$]*\[Delta][j3$, j5$] + 
      xRel[C, j1$]*xRel[C, j6$]*\[Delta][j2$, j4$]*\[Delta][j3$, j5$] + 
      xRel[C, j3$]*xRel[C, j6$]*\[Delta][j1$, j2$]*\[Delta][j4$, j5$] + 
      xRel[C, j2$]*xRel[C, j6$]*\[Delta][j1$, j3$]*\[Delta][j4$, j5$] + 
      xRel[C, j2$]*xRel[C, j3$]*\[Delta][j1$, j6$]*\[Delta][j4$, j5$] + 
      xRel[C, j1$]*xRel[C, j6$]*\[Delta][j2$, j3$]*\[Delta][j4$, j5$] + 
      xRel[C, j1$]*xRel[C, j3$]*\[Delta][j2$, j6$]*\[Delta][j4$, j5$] + 
      xRel[C, j1$]*xRel[C, j2$]*\[Delta][j3$, j6$]*\[Delta][j4$, j5$] + 
      xRel[C, j2$]*xRel[C, j3$]*\[Delta][j1$, j5$]*\[Delta][j4$, j6$] + 
      xRel[C, j1$]*xRel[C, j3$]*\[Delta][j2$, j5$]*\[Delta][j4$, j6$] + 
      xRel[C, j1$]*xRel[C, j2$]*\[Delta][j3$, j5$]*\[Delta][j4$, j6$] + 
      xRel[C, j5$]*(xRel[C, j3$]*\[Delta][j1$, j6$]*\[Delta][j2$, j4$] + 
        xRel[C, j3$]*\[Delta][j1$, j4$]*\[Delta][j2$, j6$] + 
        xRel[C, j2$]*\[Delta][j1$, j6$]*\[Delta][j3$, j4$] + 
        xRel[C, j1$]*\[Delta][j2$, j6$]*\[Delta][j3$, j4$] + 
        xRel[C, j6$]*(\[Delta][j1$, j4$]*\[Delta][j2$, j3$] + 
          \[Delta][j1$, j3$]*\[Delta][j2$, j4$] + \[Delta][j1$, j2$]*
           \[Delta][j3$, j4$]) + xRel[C, j2$]*\[Delta][j1$, j4$]*
         \[Delta][j3$, j6$] + xRel[C, j1$]*\[Delta][j2$, j4$]*
         \[Delta][j3$, j6$] + xRel[C, j4$]*(\[Delta][j1$, j6$]*
           \[Delta][j2$, j3$] + \[Delta][j1$, j3$]*\[Delta][j2$, j6$] + 
          \[Delta][j1$, j2$]*\[Delta][j3$, j6$]) + 
        (xRel[C, j3$]*\[Delta][j1$, j2$] + xRel[C, j2$]*\[Delta][j1$, j3$] + 
          xRel[C, j1$]*\[Delta][j2$, j3$])*\[Delta][j4$, j6$]) + 
      (xRel[C, j1$]*xRel[C, j3$]*\[Delta][j2$, j4$] + 
        xRel[C, j2$]*(xRel[C, j3$]*\[Delta][j1$, j4$] + 
          xRel[C, j1$]*\[Delta][j3$, j4$]))*\[Delta][j5$, j6$] + 
      xRel[C, j4$]*(xRel[C, j2$]*\[Delta][j1$, j6$]*\[Delta][j3$, j5$] + 
        xRel[C, j1$]*\[Delta][j2$, j6$]*\[Delta][j3$, j5$] + 
        xRel[C, j6$]*(\[Delta][j1$, j5$]*\[Delta][j2$, j3$] + 
          \[Delta][j1$, j3$]*\[Delta][j2$, j5$] + \[Delta][j1$, j2$]*
           \[Delta][j3$, j5$]) + xRel[C, j2$]*\[Delta][j1$, j5$]*
         \[Delta][j3$, j6$] + xRel[C, j1$]*\[Delta][j2$, j5$]*
         \[Delta][j3$, j6$] + (xRel[C, j2$]*\[Delta][j1$, j3$] + 
          xRel[C, j1$]*\[Delta][j2$, j3$])*\[Delta][j5$, j6$] + 
        xRel[C, j3$]*(\[Delta][j1$, j6$]*\[Delta][j2$, j5$] + 
          \[Delta][j1$, j5$]*\[Delta][j2$, j6$] + \[Delta][j1$, j2$]*
           \[Delta][j5$, j6$]))))/Pi^(d/2), 
 Int[dd[ks[LI[A_]]]*e[Scalar[k[LI[A_], j$_]*(xRel_)[C__, -(j$_)]]]*
    prop[ks[LI[A_]]^2]^(aa$_)] -> 
  (Gamma[-aa$ + d/2]*Scalar[xRel[C, -j$]*xRel[C, j$]]^(aa$ - d/2))/
   (2^(2*aa$)*Pi^(d/2)*Gamma[aa$]), 
 Int[dd[ks[LI[A_]]]*e[Scalar[k[LI[A_], j$_]*(xRel_)[C__, -(j$_)]]]*
    k[LI[A_], j1$_]*prop[ks[LI[A_]]^2]^(aa$_)] -> 
  (I*2^(1 - 2*aa$)*Gamma[1 - aa$ + d/2]*Scalar[xRel[C, -j$]*xRel[C, j$]]^
     (-1 + aa$ - d/2)*xRel[C, j1$])/(Pi^(d/2)*Gamma[aa$]), 
 Int[dd[ks[LI[A_]]]*e[Scalar[k[LI[A_], j$_]*(xRel_)[C__, -(j$_)]]]*
    k[LI[A_], j1$_]*k[LI[A_], j2$_]*prop[ks[LI[A_]]^2]^(aa$_)] -> 
  (-(4^(1 - aa$)*Gamma[2 - aa$ + d/2]*Scalar[xRel[C, -j$]*xRel[C, j$]]^
       (-2 + aa$ - d/2)*xRel[C, j1$]*xRel[C, j2$]) + 
    2^(1 - 2*aa$)*Gamma[1 - aa$ + d/2]*Scalar[xRel[C, -j$]*xRel[C, j$]]^
      (-1 + aa$ - d/2)*\[Delta][j1$, j2$])/(Pi^(d/2)*Gamma[aa$]), 
 Int[dd[ks[LI[A_]]]*e[Scalar[k[LI[A_], j$_]*(xRel_)[C__, -(j$_)]]]*
    k[LI[A_], j1$_]*k[LI[A_], j2$_]*k[LI[A_], j3$_]*
    prop[ks[LI[A_]]^2]^(aa$_)] -> 
  ((-I)*2^(3 - 2*aa$)*Gamma[3 - aa$ + d/2]*Scalar[xRel[C, -j$]*xRel[C, j$]]^
      (-3 + aa$ - d/2)*xRel[C, j1$]*xRel[C, j2$]*xRel[C, j3$] + 
    I*4^(1 - aa$)*Gamma[2 - aa$ + d/2]*Scalar[xRel[C, -j$]*xRel[C, j$]]^
      (-2 + aa$ - d/2)*(xRel[C, j3$]*\[Delta][j1$, j2$] + 
      xRel[C, j2$]*\[Delta][j1$, j3$] + xRel[C, j1$]*\[Delta][j2$, j3$]))/
   (Pi^(d/2)*Gamma[aa$]), 
 Int[dd[ks[LI[A_]]]*e[Scalar[k[LI[A_], j$_]*(xRel_)[C__, -(j$_)]]]*
    k[LI[A_], j1$_]*k[LI[A_], j2$_]*k[LI[A_], j3$_]*k[LI[A_], j4$_]*
    prop[ks[LI[A_]]^2]^(aa$_)] -> 
  (4^(2 - aa$)*Gamma[4 - aa$ + d/2]*Scalar[xRel[C, -j$]*xRel[C, j$]]^
      (-4 + aa$ - d/2)*xRel[C, j1$]*xRel[C, j2$]*xRel[C, j3$]*xRel[C, j4$] + 
    4^(1 - aa$)*Gamma[2 - aa$ + d/2]*Scalar[xRel[C, -j$]*xRel[C, j$]]^
      (-2 + aa$ - d/2)*(\[Delta][j1$, j4$]*\[Delta][j2$, j3$] + 
      \[Delta][j1$, j3$]*\[Delta][j2$, j4$] + \[Delta][j1$, j2$]*
       \[Delta][j3$, j4$]) - 2^(3 - 2*aa$)*Gamma[3 - aa$ + d/2]*
     Scalar[xRel[C, -j$]*xRel[C, j$]]^(-3 + aa$ - d/2)*
     (xRel[C, j1$]*xRel[C, j4$]*\[Delta][j2$, j3$] + 
      xRel[C, j3$]*(xRel[C, j4$]*\[Delta][j1$, j2$] + 
        xRel[C, j2$]*\[Delta][j1$, j4$] + xRel[C, j1$]*\[Delta][j2$, j4$]) + 
      xRel[C, j2$]*(xRel[C, j4$]*\[Delta][j1$, j3$] + 
        xRel[C, j1$]*\[Delta][j3$, j4$])))/(Pi^(d/2)*Gamma[aa$]), 
 Int[dd[ks[LI[A_]]]*e[Scalar[k[LI[A_], j$_]*(xRel_)[C__, -(j$_)]]]*
    k[LI[A_], j1$_]*k[LI[A_], j2$_]*k[LI[A_], j3$_]*k[LI[A_], j4$_]*
    k[LI[A_], j5$_]*prop[ks[LI[A_]]^2]^(aa$_)] -> 
  (I*2^(5 - 2*aa$)*Gamma[5 - aa$ + d/2]*Scalar[xRel[C, -j$]*xRel[C, j$]]^
      (-5 + aa$ - d/2)*xRel[C, j1$]*xRel[C, j2$]*xRel[C, j3$]*xRel[C, j4$]*
     xRel[C, j5$] + I*2^(3 - 2*aa$)*Gamma[3 - aa$ + d/2]*
     Scalar[xRel[C, -j$]*xRel[C, j$]]^(-3 + aa$ - d/2)*
     (xRel[C, j3$]*\[Delta][j1$, j5$]*\[Delta][j2$, j4$] + 
      xRel[C, j3$]*\[Delta][j1$, j4$]*\[Delta][j2$, j5$] + 
      xRel[C, j2$]*\[Delta][j1$, j5$]*\[Delta][j3$, j4$] + 
      ...
      (xRel[C, j3$]*\[Delta][j1$, j2$] + xRel[C, j2$]*\[Delta][j1$, j3$] + 
        xRel[C, j1$]*\[Delta][j2$, j3$])*\[Delta][j4$, j5$]) - 
    I*4^(2 - aa$)*Gamma[4 - aa$ + d/2]*Scalar[xRel[C, -j$]*xRel[C, j$]]^
      (-4 + aa$ - d/2)*(xRel[C, j1$]*xRel[C, j4$]*xRel[C, j5$]*
       \[Delta][j2$, j3$] + xRel[C, j2$]*
       (xRel[C, j5$]*(xRel[C, j4$]*\[Delta][j1$, j3$] + 
          xRel[C, j1$]*\[Delta][j3$, j4$]) + xRel[C, j1$]*xRel[C, j4$]*
         \[Delta][j3$, j5$]) + xRel[C, j3$]*
       (xRel[C, j5$]*(xRel[C, j2$]*\[Delta][j1$, j4$] + 
          xRel[C, j1$]*\[Delta][j2$, j4$]) + xRel[C, j4$]*
         (xRel[C, j5$]*\[Delta][j1$, j2$] + xRel[C, j2$]*\[Delta][j1$, j5$] + 
          xRel[C, j1$]*\[Delta][j2$, j5$]) + xRel[C, j1$]*xRel[C, j2$]*
         \[Delta][j4$, j5$])))/(Pi^(d/2)*Gamma[aa$]), 
 Int[dd[ks[LI[A_]]]*e[Scalar[k[LI[A_], j$_]*(xRel_)[C__, -(j$_)]]]*
    k[LI[A_], j1$_]*k[LI[A_], j2$_]*k[LI[A_], j3$_]*k[LI[A_], j4$_]*
    k[LI[A_], j5$_]*k[LI[A_], j6$_]*prop[ks[LI[A_]]^2]^(aa$_)] -> 
  (-(4^(3 - aa$)*Gamma[6 - aa$ + d/2]*Scalar[xRel[C, -j$]*xRel[C, j$]]^
       (-6 + aa$ - d/2)*xRel[C, j1$]*xRel[C, j2$]*xRel[C, j3$]*xRel[C, j4$]*
      xRel[C, j5$]*xRel[C, j6$]) + 2^(3 - 2*aa$)*Gamma[3 - aa$ + d/2]*
     Scalar[xRel[C, -j$]*xRel[C, j$]]^(-3 + aa$ - d/2)*
     (\[Delta][j1$, j4$]*\[Delta][j2$, j6$]*\[Delta][j3$, j5$] + 
      \[Delta][j1$, j4$]*\[Delta][j2$, j5$]*\[Delta][j3$, j6$] + 
      \[Delta][j1$, j3$]*\[Delta][j2$, j6$]*\[Delta][j4$, j5$] + 
      \[Delta][j1$, j2$]*\[Delta][j3$, j6$]*\[Delta][j4$, j5$] + 
      \[Delta][j1$, j6$]*(\[Delta][j2$, j5$]*\[Delta][j3$, j4$] + 
      ...
      (\[Delta][j1$, j4$]*\[Delta][j2$, j3$] + \[Delta][j1$, j3$]*
         \[Delta][j2$, j4$] + \[Delta][j1$, j2$]*\[Delta][j3$, j4$])*
       \[Delta][j5$, j6$]) + 2^(5 - 2*aa$)*Gamma[5 - aa$ + d/2]*
     Scalar[xRel[C, -j$]*xRel[C, j$]]^(-5 + aa$ - d/2)*
     (xRel[C, j1$]*xRel[C, j4$]*xRel[C, j5$]*xRel[C, j6$]*
       \[Delta][j2$, j3$] + xRel[C, j2$]*
       (xRel[C, j6$]*(xRel[C, j5$]*(xRel[C, j4$]*\[Delta][j1$, j3$] + 
            xRel[C, j1$]*\[Delta][j3$, j4$]) + xRel[C, j1$]*xRel[C, j4$]*
       ...
       (xRel[C, j6$]*(xRel[C, j1$]*xRel[C, j5$]*\[Delta][j2$, j4$] + 
         ...
         (xRel[C, j6$]*(xRel[C, j2$]*\[Delta][j1$, j5$] + 
          ...
          xRel[C, j1$]*xRel[C, j2$]*\[Delta][j5$, j6$]))) - 
    4^(2 - aa$)*Gamma[4 - aa$ + d/2]*Scalar[xRel[C, -j$]*xRel[C, j$]]^
      (-4 + aa$ - d/2)*(xRel[C, j3$]*xRel[C, j6$]*\[Delta][j1$, j5$]*
       \[Delta][j2$, j4$] + xRel[C, j3$]*xRel[C, j6$]*\[Delta][j1$, j4$]*
       \[Delta][j2$, j5$] + xRel[C, j2$]*xRel[C, j6$]*\[Delta][j1$, j5$]*
       \[Delta][j3$, j4$] + xRel[C, j1$]*xRel[C, j6$]*\[Delta][j2$, j5$]*
       \[Delta][j3$, j4$] + xRel[C, j2$]*xRel[C, j6$]*\[Delta][j1$, j4$]*
       \[Delta][j3$, j5$] + xRel[C, j1$]*xRel[C, j6$]*\[Delta][j2$, j4$]*
       \[Delta][j3$, j5$] + xRel[C, j3$]*xRel[C, j6$]*\[Delta][j1$, j2$]*
       \[Delta][j4$, j5$] + xRel[C, j2$]*xRel[C, j6$]*\[Delta][j1$, j3$]*
       \[Delta][j4$, j5$] + xRel[C, j2$]*xRel[C, j3$]*\[Delta][j1$, j6$]*
       \[Delta][j4$, j5$] + xRel[C, j1$]*xRel[C, j6$]*\[Delta][j2$, j3$]*
       \[Delta][j4$, j5$] + xRel[C, j1$]*xRel[C, j3$]*\[Delta][j2$, j6$]*
       \[Delta][j4$, j5$] + xRel[C, j1$]*xRel[C, j2$]*\[Delta][j3$, j6$]*
       \[Delta][j4$, j5$] + xRel[C, j2$]*xRel[C, j3$]*\[Delta][j1$, j5$]*
       \[Delta][j4$, j6$] + xRel[C, j1$]*xRel[C, j3$]*\[Delta][j2$, j5$]*
       \[Delta][j4$, j6$] + xRel[C, j1$]*xRel[C, j2$]*\[Delta][j3$, j5$]*
       \[Delta][j4$, j6$] + xRel[C, j5$]*(xRel[C, j3$]*\[Delta][j1$, j6$]*
         \[Delta][j2$, j4$] + xRel[C, j3$]*\[Delta][j1$, j4$]*
         \[Delta][j2$, j6$] + xRel[C, j2$]*\[Delta][j1$, j6$]*
         \[Delta][j3$, j4$] + xRel[C, j1$]*\[Delta][j2$, j6$]*
         \[Delta][j3$, j4$] + xRel[C, j6$]*(\[Delta][j1$, j4$]*
           \[Delta][j2$, j3$] + \[Delta][j1$, j3$]*\[Delta][j2$, j4$] + 
          \[Delta][j1$, j2$]*\[Delta][j3$, j4$]) + xRel[C, j2$]*
         \[Delta][j1$, j4$]*\[Delta][j3$, j6$] + xRel[C, j1$]*
         \[Delta][j2$, j4$]*\[Delta][j3$, j6$] + xRel[C, j4$]*
         (\[Delta][j1$, j6$]*\[Delta][j2$, j3$] + \[Delta][j1$, j3$]*
           \[Delta][j2$, j6$] + \[Delta][j1$, j2$]*\[Delta][j3$, j6$]) + 
        (xRel[C, j3$]*\[Delta][j1$, j2$] + xRel[C, j2$]*\[Delta][j1$, j3$] + 
          xRel[C, j1$]*\[Delta][j2$, j3$])*\[Delta][j4$, j6$]) + 
      (xRel[C, j1$]*xRel[C, j3$]*\[Delta][j2$, j4$] + 
        xRel[C, j2$]*(xRel[C, j3$]*\[Delta][j1$, j4$] + 
 ...
 Int[dd[ks[LI[A_]]]*k[LI[A_], j1$_]*k[LI[A_], j2$_]*k[LI[A_], j3$_]*
  ...
  ((Gamma[2 - d/2]*Gamma[-1 + d/2]*Gamma[5 + d/2]*k[LI[A1], j1$]*
    ...
    ((2^(-1 - d)*Gamma[1 - d/2]*Gamma[4 + d/2]*Gamma[d/2]*k[LI[A1], j3$]*
     ...
     prop[ks[LI[A1]]^2])/Pi^(d/2), 
 Int[dd[ks[LI[A_]]]*prop[ks[LI[A_]]^2]*prop[(ks[LI[A_]] + ks[LI[A1_]])^2]^
     (bb$_)] -> (Gamma[1 + bb$ - d/2]*Gamma[-1 + d/2]*Gamma[-bb$ + d/2]*
    prop[ks[LI[A1]]^2]^(1 + bb$ - d/2))/(2^d*Pi^(d/2)*Gamma[bb$]*
    Gamma[-1 - bb$ + d]), 
 Int[dd[ks[LI[A_]]]*k[LI[A_], j1$_]*prop[ks[LI[A_]]^2]*
    prop[(ks[LI[A_]] + ks[LI[A1_]])^2]^(bb$_)] -> 
  -((Gamma[1 + bb$ - d/2]*Gamma[-bb$ + d/2]*Gamma[d/2]*k[LI[A1], j1$]*
     prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2))/(2^d*Pi^(d/2)*Gamma[bb$]*
     Gamma[-bb$ + d])), Int[dd[ks[LI[A_]]]*k[LI[A_], j1$_]*k[LI[A_], j2$_]*
    prop[ks[LI[A_]]^2]*prop[(ks[LI[A_]] + ks[LI[A1_]])^2]^(bb$_)] -> 
  ((Gamma[1 + bb$ - d/2]*Gamma[1 + d/2]*Gamma[-bb$ + d/2]*k[LI[A1], j1$]*
      k[LI[A1], j2$]*prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2))/
     (2^d*Gamma[bb$]*Gamma[1 - bb$ + d]) + 
    (2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[1 - bb$ + d/2]*Gamma[d/2]*
      prop[ks[LI[A1]]^2]^(-1 + (2*(1 + bb$) - d)/2)*\[Delta][j2$, j1$])/
     (Gamma[bb$]*Gamma[1 - bb$ + d]))/Pi^(d/2), 
 Int[dd[ks[LI[A_]]]*k[LI[A_], j1$_]*k[LI[A_], j2$_]*k[LI[A_], j3$_]*
    prop[ks[LI[A_]]^2]*prop[(ks[LI[A_]] + ks[LI[A1_]])^2]^(bb$_)] -> 
  (-((Gamma[1 + bb$ - d/2]*Gamma[2 + d/2]*Gamma[-bb$ + d/2]*k[LI[A1], j1$]*
       k[LI[A1], j2$]*k[LI[A1], j3$]*prop[ks[LI[A1]]^2]^
        ((2*(1 + bb$) - d)/2))/(2^d*Gamma[bb$]*Gamma[2 - bb$ + d])) + 
    (-((2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[1 + d/2]*Gamma[1 - bb$ + d/2]*
         k[LI[A1], j3$]*prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*
         \[Delta][j2$, j1$])/(Gamma[bb$]*Gamma[2 - bb$ + d])) - 
      (2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[1 + d/2]*Gamma[1 - bb$ + d/2]*
        k[LI[A1], j2$]*prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*
        \[Delta][j3$, j1$])/(Gamma[bb$]*Gamma[2 - bb$ + d]) - 
      (2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[1 + d/2]*Gamma[1 - bb$ + d/2]*
        k[LI[A1], j1$]*prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*
        \[Delta][j3$, j2$])/(Gamma[bb$]*Gamma[2 - bb$ + d]))/
     prop[ks[LI[A1]]^2])/Pi^(d/2), 
 Int[dd[ks[LI[A_]]]*k[LI[A_], j1$_]*k[LI[A_], j2$_]*k[LI[A_], j3$_]*
    k[LI[A_], j4$_]*prop[ks[LI[A_]]^2]*prop[(ks[LI[A_]] + ks[LI[A1_]])^2]^
     (bb$_)] -> ((Gamma[1 + bb$ - d/2]*Gamma[3 + d/2]*Gamma[-bb$ + d/2]*
      k[LI[A1], j1$]*k[LI[A1], j2$]*k[LI[A1], j3$]*k[LI[A1], j4$]*
      prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2))/(2^d*Gamma[bb$]*
      Gamma[3 - bb$ + d]) + (2^(-2 - d)*Gamma[-1 + bb$ - d/2]*Gamma[1 + d/2]*
      Gamma[2 - bb$ + d/2]*prop[ks[LI[A1]]^2]^(-2 + (2*(1 + bb$) - d)/2)*
      (\[Delta][j3$, j2$]*\[Delta][j4$, j1$] + \[Delta][j3$, j1$]*
        \[Delta][j4$, j2$] + \[Delta][j2$, j1$]*\[Delta][j4$, j3$]))/
     (Gamma[bb$]*Gamma[3 - bb$ + d]) + 
    ((2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[2 + d/2]*Gamma[1 - bb$ + d/2]*
        k[LI[A1], j3$]*k[LI[A1], j4$]*prop[ks[LI[A1]]^2]^
         ((2*(1 + bb$) - d)/2)*\[Delta][j2$, j1$])/
       (Gamma[bb$]*Gamma[3 - bb$ + d]) + k[LI[A1], j2$]*
       ((2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[2 + d/2]*Gamma[1 - bb$ + d/2]*
          k[LI[A1], j4$]*prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*
          \[Delta][j3$, j1$])/(Gamma[bb$]*Gamma[3 - bb$ + d]) + 
        (2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[2 + d/2]*Gamma[1 - bb$ + d/2]*
          k[LI[A1], j3$]*prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*
          \[Delta][j4$, j1$])/(Gamma[bb$]*Gamma[3 - bb$ + d])) + 
      k[LI[A1], j1$]*((2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[2 + d/2]*
          Gamma[1 - bb$ + d/2]*k[LI[A1], j4$]*prop[ks[LI[A1]]^2]^
           ((2*(1 + bb$) - d)/2)*\[Delta][j3$, j2$])/
         (Gamma[bb$]*Gamma[3 - bb$ + d]) + (2^(-1 - d)*Gamma[bb$ - d/2]*
          Gamma[2 + d/2]*Gamma[1 - bb$ + d/2]*k[LI[A1], j3$]*
          prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*\[Delta][j4$, j2$])/
         (Gamma[bb$]*Gamma[3 - bb$ + d]) + (2^(-1 - d)*Gamma[bb$ - d/2]*
          Gamma[2 + d/2]*Gamma[1 - bb$ + d/2]*k[LI[A1], j2$]*
          prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*\[Delta][j4$, j3$])/
         (Gamma[bb$]*Gamma[3 - bb$ + d])))/prop[ks[LI[A1]]^2])/Pi^(d/2), 
 Int[dd[ks[LI[A_]]]*k[LI[A_], j1$_]*k[LI[A_], j2$_]*k[LI[A_], j3$_]*
    k[LI[A_], j4$_]*k[LI[A_], j5$_]*prop[ks[LI[A_]]^2]*
    prop[(ks[LI[A_]] + ks[LI[A1_]])^2]^(bb$_)] -> 
  (-((Gamma[1 + bb$ - d/2]*Gamma[4 + d/2]*Gamma[-bb$ + d/2]*k[LI[A1], j1$]*
       k[LI[A1], j2$]*k[LI[A1], j3$]*k[LI[A1], j4$]*k[LI[A1], j5$]*
       prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2))/(2^d*Gamma[bb$]*
       Gamma[4 - bb$ + d])) + 
    (-((2^(-2 - d)*Gamma[-1 + bb$ - d/2]*Gamma[2 + d/2]*Gamma[2 - bb$ + d/2]*
         k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*
         (\[Delta][j3$, j2$]*\[Delta][j4$, j1$] + \[Delta][j3$, j1$]*
           \[Delta][j4$, j2$] + \[Delta][j2$, j1$]*\[Delta][j4$, j3$]))/
        (Gamma[bb$]*Gamma[4 - bb$ + d])) - (2^(-2 - d)*Gamma[-1 + bb$ - d/2]*
        Gamma[2 + d/2]*Gamma[2 - bb$ + d/2]*k[LI[A1], j4$]*
        prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*
        (\[Delta][j3$, j2$]*\[Delta][j5$, j1$] + \[Delta][j3$, j1$]*
          \[Delta][j5$, j2$] + \[Delta][j2$, j1$]*\[Delta][j5$, j3$]))/
       (Gamma[bb$]*Gamma[4 - bb$ + d]) - (2^(-2 - d)*Gamma[-1 + bb$ - d/2]*
        Gamma[2 + d/2]*Gamma[2 - bb$ + d/2]*k[LI[A1], j3$]*
        prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*
        (\[Delta][j4$, j2$]*\[Delta][j5$, j1$] + \[Delta][j4$, j1$]*
          \[Delta][j5$, j2$] + \[Delta][j2$, j1$]*\[Delta][j5$, j4$]))/
       (Gamma[bb$]*Gamma[4 - bb$ + d]) - (2^(-2 - d)*Gamma[-1 + bb$ - d/2]*
        Gamma[2 + d/2]*Gamma[2 - bb$ + d/2]*k[LI[A1], j2$]*
        prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*
        (\[Delta][j4$, j3$]*\[Delta][j5$, j1$] + \[Delta][j4$, j1$]*
          \[Delta][j5$, j3$] + \[Delta][j3$, j1$]*\[Delta][j5$, j4$]))/
       (Gamma[bb$]*Gamma[4 - bb$ + d]) - (2^(-2 - d)*Gamma[-1 + bb$ - d/2]*
        Gamma[2 + d/2]*Gamma[2 - bb$ + d/2]*k[LI[A1], j1$]*
        prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*
        (\[Delta][j4$, j3$]*\[Delta][j5$, j2$] + \[Delta][j4$, j2$]*
          \[Delta][j5$, j3$] + \[Delta][j3$, j2$]*\[Delta][j5$, j4$]))/
       (Gamma[bb$]*Gamma[4 - bb$ + d]))/prop[ks[LI[A1]]^2]^2 + 
    (-((2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[3 + d/2]*Gamma[1 - bb$ + d/2]*
         k[LI[A1], j3$]*k[LI[A1], j4$]*k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^
          ((2*(1 + bb$) - d)/2)*\[Delta][j2$, j1$])/
        (Gamma[bb$]*Gamma[4 - bb$ + d])) + k[LI[A1], j2$]*
       (-((2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[3 + d/2]*Gamma[1 - bb$ + d/2]*
           k[LI[A1], j4$]*k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^
            ((2*(1 + bb$) - d)/2)*\[Delta][j3$, j1$])/(Gamma[bb$]*
           Gamma[4 - bb$ + d])) + k[LI[A1], j3$]*
         (-((2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[3 + d/2]*Gamma[1 - bb$ + d/2]*
             k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*
             \[Delta][j4$, j1$])/(Gamma[bb$]*Gamma[4 - bb$ + d])) - 
          (2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[3 + d/2]*Gamma[1 - bb$ + d/2]*
            k[LI[A1], j4$]*prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*
            \[Delta][j5$, j1$])/(Gamma[bb$]*Gamma[4 - bb$ + d]))) + 
      k[LI[A1], j1$]*(-((2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[3 + d/2]*
           Gamma[1 - bb$ + d/2]*k[LI[A1], j4$]*k[LI[A1], j5$]*
           prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*\[Delta][j3$, j2$])/
          (Gamma[bb$]*Gamma[4 - bb$ + d])) + k[LI[A1], j3$]*
         (-((2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[3 + d/2]*Gamma[1 - bb$ + d/2]*
             k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*
             \[Delta][j4$, j2$])/(Gamma[bb$]*Gamma[4 - bb$ + d])) - 
          (2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[3 + d/2]*Gamma[1 - bb$ + d/2]*
            k[LI[A1], j4$]*prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*
            \[Delta][j5$, j2$])/(Gamma[bb$]*Gamma[4 - bb$ + d])) + 
        k[LI[A1], j2$]*(-((2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[3 + d/2]*
             Gamma[1 - bb$ + d/2]*k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^
              ((2*(1 + bb$) - d)/2)*\[Delta][j4$, j3$])/(Gamma[bb$]*
             Gamma[4 - bb$ + d])) - (2^(-1 - d)*Gamma[bb$ - d/2]*
            Gamma[3 + d/2]*Gamma[1 - bb$ + d/2]*k[LI[A1], j4$]*
            prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*\[Delta][j5$, j3$])/
           (Gamma[bb$]*Gamma[4 - bb$ + d]) - (2^(-1 - d)*Gamma[bb$ - d/2]*
            Gamma[3 + d/2]*Gamma[1 - bb$ + d/2]*k[LI[A1], j3$]*
            prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*\[Delta][j5$, j4$])/
           (Gamma[bb$]*Gamma[4 - bb$ + d]))))/prop[ks[LI[A1]]^2])/Pi^(d/2), 
 Int[dd[ks[LI[A_]]]*k[LI[A_], j1$_]*k[LI[A_], j2$_]*k[LI[A_], j3$_]*
    k[LI[A_], j4$_]*k[LI[A_], j5$_]*k[LI[A_], j6$_]*prop[ks[LI[A_]]^2]*
    prop[(ks[LI[A_]] + ks[LI[A1_]])^2]^(bb$_)] -> 
  ((Gamma[1 + bb$ - d/2]*Gamma[5 + d/2]*Gamma[-bb$ + d/2]*k[LI[A1], j1$]*
      k[LI[A1], j2$]*k[LI[A1], j3$]*k[LI[A1], j4$]*k[LI[A1], j5$]*
      k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2))/
     (2^d*Gamma[bb$]*Gamma[5 - bb$ + d]) + 
    (2^(-3 - d)*Gamma[-2 + bb$ - d/2]*Gamma[2 + d/2]*Gamma[3 - bb$ + d/2]*
      prop[ks[LI[A1]]^2]^(-3 + (2*(1 + bb$) - d)/2)*
      (\[Delta][j3$, j2$]*\[Delta][j5$, j4$]*\[Delta][j6$, j1$] + 
       ...
       \[Delta][j4$, j2$]*(\[Delta][j5$, j3$]*\[Delta][j6$, j1$] + 
         \[Delta][j5$, j1$]*\[Delta][j6$, j3$] + \[Delta][j3$, j1$]*
          \[Delta][j6$, j5$])))/(Gamma[bb$]*Gamma[5 - bb$ + d]) + 
    ((2^(-2 - d)*Gamma[-1 + bb$ - d/2]*Gamma[3 + d/2]*Gamma[2 - bb$ + d/2]*
        k[LI[A1], j5$]*k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^
         ((2*(1 + bb$) - d)/2)*(\[Delta][j3$, j2$]*\[Delta][j4$, j1$] + 
         \[Delta][j3$, j1$]*\[Delta][j4$, j2$] + \[Delta][j2$, j1$]*
          \[Delta][j4$, j3$]))/(Gamma[bb$]*Gamma[5 - bb$ + d]) + 
      k[LI[A1], j4$]*((2^(-2 - d)*Gamma[-1 + bb$ - d/2]*Gamma[3 + d/2]*
          Gamma[2 - bb$ + d/2]*k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^
           ((2*(1 + bb$) - d)/2)*(\[Delta][j3$, j2$]*\[Delta][j5$, j1$] + 
           \[Delta][j3$, j1$]*\[Delta][j5$, j2$] + \[Delta][j2$, j1$]*
            \[Delta][j5$, j3$]))/(Gamma[bb$]*Gamma[5 - bb$ + d]) + 
        (2^(-2 - d)*Gamma[-1 + bb$ - d/2]*Gamma[3 + d/2]*Gamma[2 - bb$ + d/2]*
          k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*
          (\[Delta][j3$, j2$]*\[Delta][j6$, j1$] + \[Delta][j3$, j1$]*
            \[Delta][j6$, j2$] + \[Delta][j2$, j1$]*\[Delta][j6$, j3$]))/
         (Gamma[bb$]*Gamma[5 - bb$ + d])) + k[LI[A1], j3$]*
       ((2^(-2 - d)*Gamma[-1 + bb$ - d/2]*Gamma[3 + d/2]*Gamma[2 - bb$ + d/2]*
          k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*
          (\[Delta][j4$, j2$]*\[Delta][j5$, j1$] + \[Delta][j4$, j1$]*
            \[Delta][j5$, j2$] + \[Delta][j2$, j1$]*\[Delta][j5$, j4$]))/
         (Gamma[bb$]*Gamma[5 - bb$ + d]) + (2^(-2 - d)*Gamma[-1 + bb$ - d/2]*
          Gamma[3 + d/2]*Gamma[2 - bb$ + d/2]*k[LI[A1], j5$]*
          prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*
          (\[Delta][j4$, j2$]*\[Delta][j6$, j1$] + \[Delta][j4$, j1$]*
            \[Delta][j6$, j2$] + \[Delta][j2$, j1$]*\[Delta][j6$, j4$]))/
         (Gamma[bb$]*Gamma[5 - bb$ + d]) + (2^(-2 - d)*Gamma[-1 + bb$ - d/2]*
          Gamma[3 + d/2]*Gamma[2 - bb$ + d/2]*k[LI[A1], j4$]*
          prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*
          (\[Delta][j5$, j2$]*\[Delta][j6$, j1$] + \[Delta][j5$, j1$]*
            \[Delta][j6$, j2$] + \[Delta][j2$, j1$]*\[Delta][j6$, j5$]))/
         (Gamma[bb$]*Gamma[5 - bb$ + d])) + k[LI[A1], j2$]*
       ((2^(-2 - d)*Gamma[-1 + bb$ - d/2]*Gamma[3 + d/2]*Gamma[2 - bb$ + d/2]*
          k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*
          (\[Delta][j4$, j3$]*\[Delta][j5$, j1$] + \[Delta][j4$, j1$]*
            \[Delta][j5$, j3$] + \[Delta][j3$, j1$]*\[Delta][j5$, j4$]))/
         ...
         (Gamma[bb$]*Gamma[5 - bb$ + d]) + (2^(-2 - d)*Gamma[-1 + bb$ - d/2]*
          ...
          (\[Delta][j5$, j3$]*\[Delta][j6$, j1$] + \[Delta][j5$, j1$]*
            \[Delta][j6$, j3$] + \[Delta][j3$, j1$]*\[Delta][j6$, j5$]))/
         (Gamma[bb$]*Gamma[5 - bb$ + d]) + (2^(-2 - d)*Gamma[-1 + bb$ - d/2]*
          Gamma[3 + d/2]*Gamma[2 - bb$ + d/2]*k[LI[A1], j3$]*
          prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*
          (\[Delta][j5$, j4$]*\[Delta][j6$, j1$] + \[Delta][j5$, j1$]*
            \[Delta][j6$, j4$] + \[Delta][j4$, j1$]*\[Delta][j6$, j5$]))/
         (Gamma[bb$]*Gamma[5 - bb$ + d])) + k[LI[A1], j1$]*
       ((2^(-2 - d)*Gamma[-1 + bb$ - d/2]*Gamma[3 + d/2]*Gamma[2 - bb$ + d/2]*
          k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*
          (\[Delta][j4$, j3$]*\[Delta][j5$, j2$] + \[Delta][j4$, j2$]*
            \[Delta][j5$, j3$] + \[Delta][j3$, j2$]*\[Delta][j5$, j4$]))/
         ...
         (Gamma[bb$]*Gamma[5 - bb$ + d]) + (2^(-2 - d)*Gamma[-1 + bb$ - d/2]*
          ...
          (\[Delta][j5$, j4$]*\[Delta][j6$, j2$] + \[Delta][j5$, j2$]*
            \[Delta][j6$, j4$] + \[Delta][j4$, j2$]*\[Delta][j6$, j5$]))/
         (Gamma[bb$]*Gamma[5 - bb$ + d]) + (2^(-2 - d)*Gamma[-1 + bb$ - d/2]*
          Gamma[3 + d/2]*Gamma[2 - bb$ + d/2]*k[LI[A1], j2$]*
          prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*
          (\[Delta][j5$, j4$]*\[Delta][j6$, j3$] + \[Delta][j5$, j3$]*
            \[Delta][j6$, j4$] + \[Delta][j4$, j3$]*\[Delta][j6$, j5$]))/
         (Gamma[bb$]*Gamma[5 - bb$ + d])))/prop[ks[LI[A1]]^2]^2 + 
    ((2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[4 + d/2]*Gamma[1 - bb$ + d/2]*
        k[LI[A1], j3$]*k[LI[A1], j4$]*k[LI[A1], j5$]*k[LI[A1], j6$]*
        prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*\[Delta][j2$, j1$])/
       (Gamma[bb$]*Gamma[5 - bb$ + d]) + k[LI[A1], j2$]*
       ((2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[4 + d/2]*Gamma[1 - bb$ + d/2]*
          k[LI[A1], j4$]*k[LI[A1], j5$]*k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^
           ((2*(1 + bb$) - d)/2)*\[Delta][j3$, j1$])/
         (Gamma[bb$]*Gamma[5 - bb$ + d]) + k[LI[A1], j3$]*
         ((2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[4 + d/2]*Gamma[1 - bb$ + d/2]*
            k[LI[A1], j5$]*k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^
             ((2*(1 + bb$) - d)/2)*\[Delta][j4$, j1$])/(Gamma[bb$]*
            Gamma[5 - bb$ + d]) + k[LI[A1], j4$]*
           ((2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[4 + d/2]*Gamma[1 - bb$ + d/2]*
              k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*
              \[Delta][j5$, j1$])/(Gamma[bb$]*Gamma[5 - bb$ + d]) + 
            (2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[4 + d/2]*Gamma[1 - bb$ + d/2]*
              k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*
              \[Delta][j6$, j1$])/(Gamma[bb$]*Gamma[5 - bb$ + d])))) + 
      k[LI[A1], j1$]*((2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[4 + d/2]*
          Gamma[1 - bb$ + d/2]*k[LI[A1], j4$]*k[LI[A1], j5$]*k[LI[A1], j6$]*
          prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*\[Delta][j3$, j2$])/
         (Gamma[bb$]*Gamma[5 - bb$ + d]) + k[LI[A1], j3$]*
         ((2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[4 + d/2]*Gamma[1 - bb$ + d/2]*
            k[LI[A1], j5$]*k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^
             ((2*(1 + bb$) - d)/2)*\[Delta][j4$, j2$])/(Gamma[bb$]*
            Gamma[5 - bb$ + d]) + k[LI[A1], j4$]*
           ((2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[4 + d/2]*Gamma[1 - bb$ + d/2]*
              k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*
              \[Delta][j5$, j2$])/(Gamma[bb$]*Gamma[5 - bb$ + d]) + 
            (2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[4 + d/2]*Gamma[1 - bb$ + d/2]*
              k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*
              \[Delta][j6$, j2$])/(Gamma[bb$]*Gamma[5 - bb$ + d]))) + 
        k[LI[A1], j2$]*((2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[4 + d/2]*
            Gamma[1 - bb$ + d/2]*k[LI[A1], j5$]*k[LI[A1], j6$]*
            prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*\[Delta][j4$, j3$])/
           (Gamma[bb$]*Gamma[5 - bb$ + d]) + k[LI[A1], j4$]*
           ((2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[4 + d/2]*Gamma[1 - bb$ + d/2]*
              k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*
              \[Delta][j5$, j3$])/(Gamma[bb$]*Gamma[5 - bb$ + d]) + 
            (2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[4 + d/2]*Gamma[1 - bb$ + d/2]*
              k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*
              \[Delta][j6$, j3$])/(Gamma[bb$]*Gamma[5 - bb$ + d])) + 
          k[LI[A1], j3$]*((2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[4 + d/2]*
              Gamma[1 - bb$ + d/2]*k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^(
                (2*(1 + bb$) - d)/2)*\[Delta][j5$, j4$])/(Gamma[bb$]*
              Gamma[5 - bb$ + d]) + (2^(-1 - d)*Gamma[bb$ - d/2]*
              Gamma[4 + d/2]*Gamma[1 - bb$ + d/2]*k[LI[A1], j5$]*
              prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*\[Delta][j6$, j4$])/
             (Gamma[bb$]*Gamma[5 - bb$ + d]) + (2^(-1 - d)*Gamma[bb$ - d/2]*
              Gamma[4 + d/2]*Gamma[1 - bb$ + d/2]*k[LI[A1], j4$]*
              prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*\[Delta][j6$, j5$])/
             (Gamma[bb$]*Gamma[5 - bb$ + d])))))/prop[ks[LI[A1]]^2])/
   Pi^(d/2), Int[dd[ks[LI[A_]]]*prop[ks[LI[A_]]^2]*
    prop[(ks[LI[A_]] - ks[LI[A1_]])^2]^(bb$_)] -> 
  (Gamma[1 + bb$ - d/2]*Gamma[-1 + d/2]*Gamma[-bb$ + d/2]*
    prop[ks[LI[A1]]^2]^(1 + bb$ - d/2))/(2^d*Pi^(d/2)*Gamma[bb$]*
    Gamma[-1 - bb$ + d]), 
 Int[dd[ks[LI[A_]]]*k[LI[A_], j1$_]*prop[ks[LI[A_]]^2]*
    prop[(ks[LI[A_]] - ks[LI[A1_]])^2]^(bb$_)] -> 
 ...
 Int[dd[ks[LI[A_]]]*k[LI[A_], j1$_]*k[LI[A_], j2$_]*k[LI[A_], j3$_]*
    prop[ks[LI[A_]]^2]*prop[(ks[LI[A_]] - ks[LI[A1_]])^2]^(bb$_)] -> 
  ((Gamma[1 + bb$ - d/2]*Gamma[2 + d/2]*Gamma[-bb$ + d/2]*k[LI[A1], j1$]*
      k[LI[A1], j2$]*k[LI[A1], j3$]*prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2))/
     (2^d*Gamma[bb$]*Gamma[2 - bb$ + d]) + 
    ((2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[1 + d/2]*Gamma[1 - bb$ + d/2]*
        k[LI[A1], j3$]*prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*
        \[Delta][j2$, j1$])/(Gamma[bb$]*Gamma[2 - bb$ + d]) + 
      (2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[1 + d/2]*Gamma[1 - bb$ + d/2]*
 ...
 Int[dd[ks[LI[A_]]]*k[LI[A_], j1$_]*k[LI[A_], j2$_]*k[LI[A_], j3$_]*
    ...
    ((2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[2 + d/2]*Gamma[1 - bb$ + d/2]*
      ...
      k[LI[A1], j1$]*(-((2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[2 + d/2]*
           Gamma[1 - bb$ + d/2]*k[LI[A1], j4$]*prop[ks[LI[A1]]^2]^
            ((2*(1 + bb$) - d)/2)*\[Delta][j3$, j2$])/(Gamma[bb$]*
           Gamma[3 - bb$ + d])) - (2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[2 + d/2]*
          Gamma[1 - bb$ + d/2]*k[LI[A1], j3$]*prop[ks[LI[A1]]^2]^
           ((2*(1 + bb$) - d)/2)*\[Delta][j4$, j2$])/
         (Gamma[bb$]*Gamma[3 - bb$ + d]) - (2^(-1 - d)*Gamma[bb$ - d/2]*
          Gamma[2 + d/2]*Gamma[1 - bb$ + d/2]*k[LI[A1], j2$]*
          prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*\[Delta][j4$, j3$])/
         (Gamma[bb$]*Gamma[3 - bb$ + d])))/prop[ks[LI[A1]]^2])/Pi^(d/2), 
    ...
    ((2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[3 + d/2]*Gamma[1 - bb$ + d/2]*
      ...
      k[LI[A1], j1$]*(-((2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[3 + d/2]*
        ...
        k[LI[A1], j2$]*((2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[3 + d/2]*
            Gamma[1 - bb$ + d/2]*k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^
             ((2*(1 + bb$) - d)/2)*\[Delta][j4$, j3$])/(Gamma[bb$]*
            Gamma[4 - bb$ + d]) + (2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[3 + d/2]*
            Gamma[1 - bb$ + d/2]*k[LI[A1], j4$]*prop[ks[LI[A1]]^2]^
             ((2*(1 + bb$) - d)/2)*\[Delta][j5$, j3$])/(Gamma[bb$]*
            Gamma[4 - bb$ + d]) + (2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[3 + d/2]*
            Gamma[1 - bb$ + d/2]*k[LI[A1], j3$]*prop[ks[LI[A1]]^2]^
             ((2*(1 + bb$) - d)/2)*\[Delta][j5$, j4$])/(Gamma[bb$]*
            Gamma[4 - bb$ + d]))))/prop[ks[LI[A1]]^2])/Pi^(d/2), 
 Int[dd[ks[LI[A_]]]*k[LI[A_], j1$_]*k[LI[A_], j2$_]*k[LI[A_], j3$_]*
    k[LI[A_], j4$_]*k[LI[A_], j5$_]*k[LI[A_], j6$_]*prop[ks[LI[A_]]^2]*
    prop[(ks[LI[A_]] - ks[LI[A1_]])^2]^(bb$_)] -> 
  ((Gamma[1 + bb$ - d/2]*Gamma[5 + d/2]*Gamma[-bb$ + d/2]*k[LI[A1], j1$]*
      ...
      k[LI[A1], j4$]*(-((2^(-2 - d)*Gamma[-1 + bb$ - d/2]*Gamma[3 + d/2]*
        ...
        (2^(-2 - d)*Gamma[-1 + bb$ - d/2]*Gamma[3 + d/2]*Gamma[2 - bb$ + d/2]*
          ...
          (\[Delta][j3$, j2$]*\[Delta][j6$, j1$] + \[Delta][j3$, j1$]*
            \[Delta][j6$, j2$] + \[Delta][j2$, j1$]*\[Delta][j6$, j3$]))/
         (Gamma[bb$]*Gamma[5 - bb$ + d])) - k[LI[A1], j3$]*
       (-((2^(-2 - d)*Gamma[-1 + bb$ - d/2]*Gamma[3 + d/2]*
           Gamma[2 - bb$ + d/2]*k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^
            ((2*(1 + bb$) - d)/2)*(\[Delta][j4$, j2$]*\[Delta][j5$, j1$] + 
            \[Delta][j4$, j1$]*\[Delta][j5$, j2$] + \[Delta][j2$, j1$]*
             \[Delta][j5$, j4$]))/(Gamma[bb$]*Gamma[5 - bb$ + d])) - 
        (2^(-2 - d)*Gamma[-1 + bb$ - d/2]*Gamma[3 + d/2]*Gamma[2 - bb$ + d/2]*
          k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*
          (\[Delta][j4$, j2$]*\[Delta][j6$, j1$] + \[Delta][j4$, j1$]*
            \[Delta][j6$, j2$] + \[Delta][j2$, j1$]*\[Delta][j6$, j4$]))/
       ...
       (-((2^(-2 - d)*Gamma[-1 + bb$ - d/2]*Gamma[3 + d/2]*
           Gamma[2 - bb$ + d/2]*k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^
            ((2*(1 + bb$) - d)/2)*(\[Delta][j4$, j3$]*\[Delta][j5$, j1$] + 
       ...
       (-((2^(-2 - d)*Gamma[-1 + bb$ - d/2]*Gamma[3 + d/2]*
           Gamma[2 - bb$ + d/2]*k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^
            ((2*(1 + bb$) - d)/2)*(\[Delta][j4$, j3$]*\[Delta][j5$, j2$] + 
    ...
    ((2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[4 + d/2]*Gamma[1 - bb$ + d/2]*
       ...
       (-((2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[4 + d/2]*Gamma[1 - bb$ + d/2]*
           k[LI[A1], j4$]*k[LI[A1], j5$]*k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^
            ((2*(1 + bb$) - d)/2)*\[Delta][j3$, j1$])/(Gamma[bb$]*
           Gamma[5 - bb$ + d])) - k[LI[A1], j3$]*
         ((2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[4 + d/2]*Gamma[1 - bb$ + d/2]*
            k[LI[A1], j5$]*k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^
             ((2*(1 + bb$) - d)/2)*\[Delta][j4$, j1$])/(Gamma[bb$]*
            Gamma[5 - bb$ + d]) - k[LI[A1], j4$]*
           (-((2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[4 + d/2]*Gamma[1 - bb$ + 
                 d/2]*k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*
               \[Delta][j5$, j1$])/(Gamma[bb$]*Gamma[5 - bb$ + d])) - 
            (2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[4 + d/2]*Gamma[1 - bb$ + d/2]*
              k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*
              \[Delta][j6$, j1$])/(Gamma[bb$]*Gamma[5 - bb$ + d])))) - 
        ...
        k[LI[A1], j2$]*((2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[4 + d/2]*
           ...
           (-((2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[4 + d/2]*Gamma[1 - bb$ + 
            ...
            (2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[4 + d/2]*Gamma[1 - bb$ + d/2]*
              k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*
              \[Delta][j6$, j3$])/(Gamma[bb$]*Gamma[5 - bb$ + d])) - 
          k[LI[A1], j3$]*(-((2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[4 + d/2]*Gamma[
                1 - bb$ + d/2]*k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^
                ((2*(1 + bb$) - d)/2)*\[Delta][j5$, j4$])/(Gamma[bb$]*Gamma[
                5 - bb$ + d])) - (2^(-1 - d)*Gamma[bb$ - d/2]*Gamma[4 + d/2]*
              Gamma[1 - bb$ + d/2]*k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^(
                (2*(1 + bb$) - d)/2)*\[Delta][j6$, j4$])/(Gamma[bb$]*
              Gamma[5 - bb$ + d]) - (2^(-1 - d)*Gamma[bb$ - d/2]*
              Gamma[4 + d/2]*Gamma[1 - bb$ + d/2]*k[LI[A1], j4$]*
              prop[ks[LI[A1]]^2]^((2*(1 + bb$) - d)/2)*\[Delta][j6$, j5$])/
             (Gamma[bb$]*Gamma[5 - bb$ + d])))))/prop[ks[LI[A1]]^2])/
   Pi^(d/2), Int[dd[ks[LI[A_]]]*prop[ks[LI[A_]]^2]^(aa$_)*
    prop[(ks[LI[A_]] + ks[LI[A1_]])^2]] -> 
  (Gamma[1 + aa$ - d/2]*Gamma[-1 + d/2]*Gamma[-aa$ + d/2]*
    prop[ks[LI[A1]]^2]^(1 + aa$ - d/2))/(2^d*Pi^(d/2)*Gamma[aa$]*
    Gamma[-1 - aa$ + d]), 
 Int[dd[ks[LI[A_]]]*k[LI[A_], j1$_]*prop[ks[LI[A_]]^2]^(aa$_)*
    prop[(ks[LI[A_]] + ks[LI[A1_]])^2]] -> 
  -((Gamma[1 + aa$ - d/2]*Gamma[-1 + d/2]*Gamma[1 - aa$ + d/2]*k[LI[A1], j1$]*
     prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2))/(2^d*Pi^(d/2)*Gamma[aa$]*
     Gamma[-aa$ + d])), Int[dd[ks[LI[A_]]]*k[LI[A_], j1$_]*k[LI[A_], j2$_]*
    prop[ks[LI[A_]]^2]^(aa$_)*prop[(ks[LI[A_]] + ks[LI[A1_]])^2]] -> 
  ((Gamma[1 + aa$ - d/2]*Gamma[-1 + d/2]*Gamma[2 - aa$ + d/2]*k[LI[A1], j1$]*
      k[LI[A1], j2$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2))/
     (2^d*Gamma[aa$]*Gamma[1 - aa$ + d]) + 
    (2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[1 - aa$ + d/2]*Gamma[d/2]*
      prop[ks[LI[A1]]^2]^(-1 + (2*(1 + aa$) - d)/2)*\[Delta][j2$, j1$])/
     (Gamma[aa$]*Gamma[1 - aa$ + d]))/Pi^(d/2), 
 Int[dd[ks[LI[A_]]]*k[LI[A_], j1$_]*k[LI[A_], j2$_]*k[LI[A_], j3$_]*
    prop[ks[LI[A_]]^2]^(aa$_)*prop[(ks[LI[A_]] + ks[LI[A1_]])^2]] -> 
  (-((Gamma[1 + aa$ - d/2]*Gamma[-1 + d/2]*Gamma[3 - aa$ + d/2]*
       k[LI[A1], j1$]*k[LI[A1], j2$]*k[LI[A1], j3$]*prop[ks[LI[A1]]^2]^
        ((2*(1 + aa$) - d)/2))/(2^d*Gamma[aa$]*Gamma[2 - aa$ + d])) + 
    (-((2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[2 - aa$ + d/2]*Gamma[d/2]*
         k[LI[A1], j3$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
         \[Delta][j2$, j1$])/(Gamma[aa$]*Gamma[2 - aa$ + d])) - 
      (2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[2 - aa$ + d/2]*Gamma[d/2]*
        k[LI[A1], j2$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
        \[Delta][j3$, j1$])/(Gamma[aa$]*Gamma[2 - aa$ + d]) - 
      (2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[2 - aa$ + d/2]*Gamma[d/2]*
        k[LI[A1], j1$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
        \[Delta][j3$, j2$])/(Gamma[aa$]*Gamma[2 - aa$ + d]))/
     prop[ks[LI[A1]]^2])/Pi^(d/2), 
 Int[dd[ks[LI[A_]]]*k[LI[A_], j1$_]*k[LI[A_], j2$_]*k[LI[A_], j3$_]*
    k[LI[A_], j4$_]*prop[ks[LI[A_]]^2]^(aa$_)*
    prop[(ks[LI[A_]] + ks[LI[A1_]])^2]] -> 
  ((Gamma[1 + aa$ - d/2]*Gamma[-1 + d/2]*Gamma[4 - aa$ + d/2]*k[LI[A1], j1$]*
      k[LI[A1], j2$]*k[LI[A1], j3$]*k[LI[A1], j4$]*prop[ks[LI[A1]]^2]^
       ((2*(1 + aa$) - d)/2))/(2^d*Gamma[aa$]*Gamma[3 - aa$ + d]) + 
    (2^(-2 - d)*Gamma[-1 + aa$ - d/2]*Gamma[1 + d/2]*Gamma[2 - aa$ + d/2]*
      prop[ks[LI[A1]]^2]^(-2 + (2*(1 + aa$) - d)/2)*
      (\[Delta][j3$, j2$]*\[Delta][j4$, j1$] + \[Delta][j3$, j1$]*
        \[Delta][j4$, j2$] + \[Delta][j2$, j1$]*\[Delta][j4$, j3$]))/
     (Gamma[aa$]*Gamma[3 - aa$ + d]) + 
    ((2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[3 - aa$ + d/2]*Gamma[d/2]*
        k[LI[A1], j3$]*k[LI[A1], j4$]*prop[ks[LI[A1]]^2]^
         ((2*(1 + aa$) - d)/2)*\[Delta][j2$, j1$])/
       (Gamma[aa$]*Gamma[3 - aa$ + d]) + k[LI[A1], j2$]*
       ((2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[3 - aa$ + d/2]*Gamma[d/2]*
          k[LI[A1], j4$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
          \[Delta][j3$, j1$])/(Gamma[aa$]*Gamma[3 - aa$ + d]) + 
        (2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[3 - aa$ + d/2]*Gamma[d/2]*
          k[LI[A1], j3$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
          \[Delta][j4$, j1$])/(Gamma[aa$]*Gamma[3 - aa$ + d])) + 
      k[LI[A1], j1$]*((2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[3 - aa$ + d/2]*
          Gamma[d/2]*k[LI[A1], j4$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
          \[Delta][j3$, j2$])/(Gamma[aa$]*Gamma[3 - aa$ + d]) + 
        (2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[3 - aa$ + d/2]*Gamma[d/2]*
          k[LI[A1], j3$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
          \[Delta][j4$, j2$])/(Gamma[aa$]*Gamma[3 - aa$ + d]) + 
        (2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[3 - aa$ + d/2]*Gamma[d/2]*
          k[LI[A1], j2$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
          \[Delta][j4$, j3$])/(Gamma[aa$]*Gamma[3 - aa$ + d])))/
     prop[ks[LI[A1]]^2])/Pi^(d/2), 
 Int[dd[ks[LI[A_]]]*k[LI[A_], j1$_]*k[LI[A_], j2$_]*k[LI[A_], j3$_]*
    k[LI[A_], j4$_]*k[LI[A_], j5$_]*prop[ks[LI[A_]]^2]^(aa$_)*
    prop[(ks[LI[A_]] + ks[LI[A1_]])^2]] -> 
  (-((Gamma[1 + aa$ - d/2]*Gamma[-1 + d/2]*Gamma[5 - aa$ + d/2]*
       k[LI[A1], j1$]*k[LI[A1], j2$]*k[LI[A1], j3$]*k[LI[A1], j4$]*
       k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2))/
      (2^d*Gamma[aa$]*Gamma[4 - aa$ + d])) + 
    (-((2^(-2 - d)*Gamma[-1 + aa$ - d/2]*Gamma[1 + d/2]*Gamma[3 - aa$ + d/2]*
         k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
         (\[Delta][j3$, j2$]*\[Delta][j4$, j1$] + \[Delta][j3$, j1$]*
           \[Delta][j4$, j2$] + \[Delta][j2$, j1$]*\[Delta][j4$, j3$]))/
        (Gamma[aa$]*Gamma[4 - aa$ + d])) - (2^(-2 - d)*Gamma[-1 + aa$ - d/2]*
        Gamma[1 + d/2]*Gamma[3 - aa$ + d/2]*k[LI[A1], j4$]*
        prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
        (\[Delta][j3$, j2$]*\[Delta][j5$, j1$] + \[Delta][j3$, j1$]*
          \[Delta][j5$, j2$] + \[Delta][j2$, j1$]*\[Delta][j5$, j3$]))/
       (Gamma[aa$]*Gamma[4 - aa$ + d]) - (2^(-2 - d)*Gamma[-1 + aa$ - d/2]*
        Gamma[1 + d/2]*Gamma[3 - aa$ + d/2]*k[LI[A1], j3$]*
        prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
        (\[Delta][j4$, j2$]*\[Delta][j5$, j1$] + \[Delta][j4$, j1$]*
          \[Delta][j5$, j2$] + \[Delta][j2$, j1$]*\[Delta][j5$, j4$]))/
       (Gamma[aa$]*Gamma[4 - aa$ + d]) - (2^(-2 - d)*Gamma[-1 + aa$ - d/2]*
        Gamma[1 + d/2]*Gamma[3 - aa$ + d/2]*k[LI[A1], j2$]*
        prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
        (\[Delta][j4$, j3$]*\[Delta][j5$, j1$] + \[Delta][j4$, j1$]*
          \[Delta][j5$, j3$] + \[Delta][j3$, j1$]*\[Delta][j5$, j4$]))/
       (Gamma[aa$]*Gamma[4 - aa$ + d]) - (2^(-2 - d)*Gamma[-1 + aa$ - d/2]*
        Gamma[1 + d/2]*Gamma[3 - aa$ + d/2]*k[LI[A1], j1$]*
        prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
        (\[Delta][j4$, j3$]*\[Delta][j5$, j2$] + \[Delta][j4$, j2$]*
          \[Delta][j5$, j3$] + \[Delta][j3$, j2$]*\[Delta][j5$, j4$]))/
       (Gamma[aa$]*Gamma[4 - aa$ + d]))/prop[ks[LI[A1]]^2]^2 + 
    (-((2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[4 - aa$ + d/2]*Gamma[d/2]*
         k[LI[A1], j3$]*k[LI[A1], j4$]*k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^
          ((2*(1 + aa$) - d)/2)*\[Delta][j2$, j1$])/
        (Gamma[aa$]*Gamma[4 - aa$ + d])) + k[LI[A1], j2$]*
       (-((2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[4 - aa$ + d/2]*Gamma[d/2]*
           k[LI[A1], j4$]*k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^
            ((2*(1 + aa$) - d)/2)*\[Delta][j3$, j1$])/(Gamma[aa$]*
           Gamma[4 - aa$ + d])) + k[LI[A1], j3$]*
         (-((2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[4 - aa$ + d/2]*Gamma[d/2]*
             k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
             \[Delta][j4$, j1$])/(Gamma[aa$]*Gamma[4 - aa$ + d])) - 
          (2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[4 - aa$ + d/2]*Gamma[d/2]*
            k[LI[A1], j4$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
            \[Delta][j5$, j1$])/(Gamma[aa$]*Gamma[4 - aa$ + d]))) + 
      k[LI[A1], j1$]*(-((2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[4 - aa$ + d/2]*
           Gamma[d/2]*k[LI[A1], j4$]*k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^
            ((2*(1 + aa$) - d)/2)*\[Delta][j3$, j2$])/(Gamma[aa$]*
           Gamma[4 - aa$ + d])) + k[LI[A1], j3$]*
         (-((2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[4 - aa$ + d/2]*Gamma[d/2]*
             k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
             \[Delta][j4$, j2$])/(Gamma[aa$]*Gamma[4 - aa$ + d])) - 
          (2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[4 - aa$ + d/2]*Gamma[d/2]*
            k[LI[A1], j4$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
            \[Delta][j5$, j2$])/(Gamma[aa$]*Gamma[4 - aa$ + d])) + 
        k[LI[A1], j2$]*(-((2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[4 - aa$ + d/2]*
             Gamma[d/2]*k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - 
                d)/2)*\[Delta][j4$, j3$])/(Gamma[aa$]*Gamma[4 - aa$ + d])) - 
          (2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[4 - aa$ + d/2]*Gamma[d/2]*
            k[LI[A1], j4$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
            \[Delta][j5$, j3$])/(Gamma[aa$]*Gamma[4 - aa$ + d]) - 
          (2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[4 - aa$ + d/2]*Gamma[d/2]*
            k[LI[A1], j3$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
            \[Delta][j5$, j4$])/(Gamma[aa$]*Gamma[4 - aa$ + d]))))/
     prop[ks[LI[A1]]^2])/Pi^(d/2), 
 Int[dd[ks[LI[A_]]]*k[LI[A_], j1$_]*k[LI[A_], j2$_]*k[LI[A_], j3$_]*
    k[LI[A_], j4$_]*k[LI[A_], j5$_]*k[LI[A_], j6$_]*prop[ks[LI[A_]]^2]^(aa$_)*
    prop[(ks[LI[A_]] + ks[LI[A1_]])^2]] -> 
  ((Gamma[1 + aa$ - d/2]*Gamma[-1 + d/2]*Gamma[6 - aa$ + d/2]*k[LI[A1], j1$]*
      k[LI[A1], j2$]*k[LI[A1], j3$]*k[LI[A1], j4$]*k[LI[A1], j5$]*
      k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2))/
     (2^d*Gamma[aa$]*Gamma[5 - aa$ + d]) + 
    (2^(-3 - d)*Gamma[-2 + aa$ - d/2]*Gamma[2 + d/2]*Gamma[3 - aa$ + d/2]*
      prop[ks[LI[A1]]^2]^(-3 + (2*(1 + aa$) - d)/2)*
      (\[Delta][j3$, j2$]*\[Delta][j5$, j4$]*\[Delta][j6$, j1$] + 
       \[Delta][j3$, j1$]*\[Delta][j5$, j4$]*\[Delta][j6$, j2$] + 
       \[Delta][j2$, j1$]*\[Delta][j5$, j4$]*\[Delta][j6$, j3$] + 
       \[Delta][j4$, j1$]*(\[Delta][j5$, j3$]*\[Delta][j6$, j2$] + 
       ...
       \[Delta][j4$, j2$]*(\[Delta][j5$, j3$]*\[Delta][j6$, j1$] + 
         \[Delta][j5$, j1$]*\[Delta][j6$, j3$] + \[Delta][j3$, j1$]*
          \[Delta][j6$, j5$])))/(Gamma[aa$]*Gamma[5 - aa$ + d]) + 
    ((2^(-2 - d)*Gamma[-1 + aa$ - d/2]*Gamma[1 + d/2]*Gamma[4 - aa$ + d/2]*
        k[LI[A1], j5$]*k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^
         ((2*(1 + aa$) - d)/2)*(\[Delta][j3$, j2$]*\[Delta][j4$, j1$] + 
         \[Delta][j3$, j1$]*\[Delta][j4$, j2$] + \[Delta][j2$, j1$]*
          \[Delta][j4$, j3$]))/(Gamma[aa$]*Gamma[5 - aa$ + d]) + 
      k[LI[A1], j4$]*((2^(-2 - d)*Gamma[-1 + aa$ - d/2]*Gamma[1 + d/2]*
          Gamma[4 - aa$ + d/2]*k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^
           ((2*(1 + aa$) - d)/2)*(\[Delta][j3$, j2$]*\[Delta][j5$, j1$] + 
           \[Delta][j3$, j1$]*\[Delta][j5$, j2$] + \[Delta][j2$, j1$]*
            \[Delta][j5$, j3$]))/(Gamma[aa$]*Gamma[5 - aa$ + d]) + 
        (2^(-2 - d)*Gamma[-1 + aa$ - d/2]*Gamma[1 + d/2]*Gamma[4 - aa$ + d/2]*
          k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
          (\[Delta][j3$, j2$]*\[Delta][j6$, j1$] + \[Delta][j3$, j1$]*
            \[Delta][j6$, j2$] + \[Delta][j2$, j1$]*\[Delta][j6$, j3$]))/
         (Gamma[aa$]*Gamma[5 - aa$ + d])) + k[LI[A1], j3$]*
       ((2^(-2 - d)*Gamma[-1 + aa$ - d/2]*Gamma[1 + d/2]*Gamma[4 - aa$ + d/2]*
          k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
          (\[Delta][j4$, j2$]*\[Delta][j5$, j1$] + \[Delta][j4$, j1$]*
            \[Delta][j5$, j2$] + \[Delta][j2$, j1$]*\[Delta][j5$, j4$]))/
         (Gamma[aa$]*Gamma[5 - aa$ + d]) + (2^(-2 - d)*Gamma[-1 + aa$ - d/2]*
          Gamma[1 + d/2]*Gamma[4 - aa$ + d/2]*k[LI[A1], j5$]*
          prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
          (\[Delta][j4$, j2$]*\[Delta][j6$, j1$] + \[Delta][j4$, j1$]*
            \[Delta][j6$, j2$] + \[Delta][j2$, j1$]*\[Delta][j6$, j4$]))/
         (Gamma[aa$]*Gamma[5 - aa$ + d]) + (2^(-2 - d)*Gamma[-1 + aa$ - d/2]*
          Gamma[1 + d/2]*Gamma[4 - aa$ + d/2]*k[LI[A1], j4$]*
          prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
          (\[Delta][j5$, j2$]*\[Delta][j6$, j1$] + \[Delta][j5$, j1$]*
            \[Delta][j6$, j2$] + \[Delta][j2$, j1$]*\[Delta][j6$, j5$]))/
         (Gamma[aa$]*Gamma[5 - aa$ + d])) + k[LI[A1], j2$]*
       ((2^(-2 - d)*Gamma[-1 + aa$ - d/2]*Gamma[1 + d/2]*Gamma[4 - aa$ + d/2]*
          k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
          (\[Delta][j4$, j3$]*\[Delta][j5$, j1$] + \[Delta][j4$, j1$]*
            \[Delta][j5$, j3$] + \[Delta][j3$, j1$]*\[Delta][j5$, j4$]))/
         ...
         (Gamma[aa$]*Gamma[5 - aa$ + d]) + (2^(-2 - d)*Gamma[-1 + aa$ - d/2]*
          ...
          (\[Delta][j5$, j3$]*\[Delta][j6$, j1$] + \[Delta][j5$, j1$]*
            \[Delta][j6$, j3$] + \[Delta][j3$, j1$]*\[Delta][j6$, j5$]))/
         (Gamma[aa$]*Gamma[5 - aa$ + d]) + (2^(-2 - d)*Gamma[-1 + aa$ - d/2]*
          Gamma[1 + d/2]*Gamma[4 - aa$ + d/2]*k[LI[A1], j3$]*
          prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
          (\[Delta][j5$, j4$]*\[Delta][j6$, j1$] + \[Delta][j5$, j1$]*
            \[Delta][j6$, j4$] + \[Delta][j4$, j1$]*\[Delta][j6$, j5$]))/
         (Gamma[aa$]*Gamma[5 - aa$ + d])) + k[LI[A1], j1$]*
       ((2^(-2 - d)*Gamma[-1 + aa$ - d/2]*Gamma[1 + d/2]*Gamma[4 - aa$ + d/2]*
          k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
          (\[Delta][j4$, j3$]*\[Delta][j5$, j2$] + \[Delta][j4$, j2$]*
            \[Delta][j5$, j3$] + \[Delta][j3$, j2$]*\[Delta][j5$, j4$]))/
         ...
         (Gamma[aa$]*Gamma[5 - aa$ + d]) + (2^(-2 - d)*Gamma[-1 + aa$ - d/2]*
          ...
          (\[Delta][j5$, j4$]*\[Delta][j6$, j2$] + \[Delta][j5$, j2$]*
            \[Delta][j6$, j4$] + \[Delta][j4$, j2$]*\[Delta][j6$, j5$]))/
         (Gamma[aa$]*Gamma[5 - aa$ + d]) + (2^(-2 - d)*Gamma[-1 + aa$ - d/2]*
          Gamma[1 + d/2]*Gamma[4 - aa$ + d/2]*k[LI[A1], j2$]*
          prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
          (\[Delta][j5$, j4$]*\[Delta][j6$, j3$] + \[Delta][j5$, j3$]*
            \[Delta][j6$, j4$] + \[Delta][j4$, j3$]*\[Delta][j6$, j5$]))/
         (Gamma[aa$]*Gamma[5 - aa$ + d])))/prop[ks[LI[A1]]^2]^2 + 
    ((2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[5 - aa$ + d/2]*Gamma[d/2]*
        k[LI[A1], j3$]*k[LI[A1], j4$]*k[LI[A1], j5$]*k[LI[A1], j6$]*
        prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*\[Delta][j2$, j1$])/
       (Gamma[aa$]*Gamma[5 - aa$ + d]) + k[LI[A1], j2$]*
       ((2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[5 - aa$ + d/2]*Gamma[d/2]*
          k[LI[A1], j4$]*k[LI[A1], j5$]*k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^
           ((2*(1 + aa$) - d)/2)*\[Delta][j3$, j1$])/
         (Gamma[aa$]*Gamma[5 - aa$ + d]) + k[LI[A1], j3$]*
         ((2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[5 - aa$ + d/2]*Gamma[d/2]*
            k[LI[A1], j5$]*k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^
             ((2*(1 + aa$) - d)/2)*\[Delta][j4$, j1$])/(Gamma[aa$]*
            Gamma[5 - aa$ + d]) + k[LI[A1], j4$]*
           ((2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[5 - aa$ + d/2]*Gamma[d/2]*
              k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
              \[Delta][j5$, j1$])/(Gamma[aa$]*Gamma[5 - aa$ + d]) + 
            (2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[5 - aa$ + d/2]*Gamma[d/2]*
              k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
              \[Delta][j6$, j1$])/(Gamma[aa$]*Gamma[5 - aa$ + d])))) + 
      k[LI[A1], j1$]*((2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[5 - aa$ + d/2]*
          Gamma[d/2]*k[LI[A1], j4$]*k[LI[A1], j5$]*k[LI[A1], j6$]*
          prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*\[Delta][j3$, j2$])/
         (Gamma[aa$]*Gamma[5 - aa$ + d]) + k[LI[A1], j3$]*
         ((2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[5 - aa$ + d/2]*Gamma[d/2]*
            k[LI[A1], j5$]*k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^
             ((2*(1 + aa$) - d)/2)*\[Delta][j4$, j2$])/(Gamma[aa$]*
            Gamma[5 - aa$ + d]) + k[LI[A1], j4$]*
           ((2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[5 - aa$ + d/2]*Gamma[d/2]*
              k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
              \[Delta][j5$, j2$])/(Gamma[aa$]*Gamma[5 - aa$ + d]) + 
            (2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[5 - aa$ + d/2]*Gamma[d/2]*
              k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
              \[Delta][j6$, j2$])/(Gamma[aa$]*Gamma[5 - aa$ + d]))) + 
        k[LI[A1], j2$]*((2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[5 - aa$ + d/2]*
            Gamma[d/2]*k[LI[A1], j5$]*k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^
             ((2*(1 + aa$) - d)/2)*\[Delta][j4$, j3$])/(Gamma[aa$]*
            Gamma[5 - aa$ + d]) + k[LI[A1], j4$]*
           ((2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[5 - aa$ + d/2]*Gamma[d/2]*
              k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
              \[Delta][j5$, j3$])/(Gamma[aa$]*Gamma[5 - aa$ + d]) + 
            (2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[5 - aa$ + d/2]*Gamma[d/2]*
              k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
              \[Delta][j6$, j3$])/(Gamma[aa$]*Gamma[5 - aa$ + d])) + 
          k[LI[A1], j3$]*((2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[5 - aa$ + d/2]*
              Gamma[d/2]*k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/
                2)*\[Delta][j5$, j4$])/(Gamma[aa$]*Gamma[5 - aa$ + d]) + 
            (2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[5 - aa$ + d/2]*Gamma[d/2]*
              k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
              \[Delta][j6$, j4$])/(Gamma[aa$]*Gamma[5 - aa$ + d]) + 
            (2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[5 - aa$ + d/2]*Gamma[d/2]*
              k[LI[A1], j4$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
              \[Delta][j6$, j5$])/(Gamma[aa$]*Gamma[5 - aa$ + d])))))/
     prop[ks[LI[A1]]^2])/Pi^(d/2), 
 Int[dd[ks[LI[A_]]]*prop[ks[LI[A_]]^2]^(aa$_)*
    prop[(ks[LI[A_]] - ks[LI[A1_]])^2]] -> 
  (Gamma[1 + aa$ - d/2]*Gamma[-1 + d/2]*Gamma[-aa$ + d/2]*
    prop[ks[LI[A1]]^2]^(1 + aa$ - d/2))/(2^d*Pi^(d/2)*Gamma[aa$]*
    Gamma[-1 - aa$ + d]), 
 ...
 Int[dd[ks[LI[A_]]]*k[LI[A_], j1$_]*k[LI[A_], j2$_]*k[LI[A_], j3$_]*
    prop[ks[LI[A_]]^2]^(aa$_)*prop[(ks[LI[A_]] - ks[LI[A1_]])^2]] -> 
  ((Gamma[1 + aa$ - d/2]*Gamma[-1 + d/2]*Gamma[3 - aa$ + d/2]*k[LI[A1], j1$]*
      k[LI[A1], j2$]*k[LI[A1], j3$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2))/
     (2^d*Gamma[aa$]*Gamma[2 - aa$ + d]) + 
    ((2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[2 - aa$ + d/2]*Gamma[d/2]*
        k[LI[A1], j3$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
        \[Delta][j2$, j1$])/(Gamma[aa$]*Gamma[2 - aa$ + d]) + 
      (2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[2 - aa$ + d/2]*Gamma[d/2]*
 ...
 Int[dd[ks[LI[A_]]]*k[LI[A_], j1$_]*k[LI[A_], j2$_]*k[LI[A_], j3$_]*
    k[LI[A_], j4$_]*k[LI[A_], j5$_]*prop[ks[LI[A_]]^2]^(aa$_)*
    prop[(ks[LI[A_]] - ks[LI[A1_]])^2]] -> 
  ((Gamma[1 + aa$ - d/2]*Gamma[-1 + d/2]*Gamma[5 - aa$ + d/2]*k[LI[A1], j1$]*
      k[LI[A1], j2$]*k[LI[A1], j3$]*k[LI[A1], j4$]*k[LI[A1], j5$]*
      prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2))/(2^d*Gamma[aa$]*
      Gamma[4 - aa$ + d]) + 
    ((2^(-2 - d)*Gamma[-1 + aa$ - d/2]*Gamma[1 + d/2]*Gamma[3 - aa$ + d/2]*
        k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
        (\[Delta][j3$, j2$]*\[Delta][j4$, j1$] + \[Delta][j3$, j1$]*
      ...
      k[LI[A1], j1$]*(-((2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[4 - aa$ + d/2]*
         ...
         ((2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[4 - aa$ + d/2]*Gamma[d/2]*
          ...
          (2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[4 - aa$ + d/2]*Gamma[d/2]*
            ...
            \[Delta][j5$, j2$])/(Gamma[aa$]*Gamma[4 - aa$ + d])) - 
        k[LI[A1], j2$]*((2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[4 - aa$ + d/2]*
            Gamma[d/2]*k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/
              2)*\[Delta][j4$, j3$])/(Gamma[aa$]*Gamma[4 - aa$ + d]) + 
          (2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[4 - aa$ + d/2]*Gamma[d/2]*
            k[LI[A1], j4$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
            \[Delta][j5$, j3$])/(Gamma[aa$]*Gamma[4 - aa$ + d]) + 
          (2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[4 - aa$ + d/2]*Gamma[d/2]*
  ...
  ((Gamma[1 + aa$ - d/2]*Gamma[-1 + d/2]*Gamma[6 - aa$ + d/2]*k[LI[A1], j1$]*
      ...
      k[LI[A1], j4$]*(-((2^(-2 - d)*Gamma[-1 + aa$ - d/2]*Gamma[1 + d/2]*
        ...
        (2^(-2 - d)*Gamma[-1 + aa$ - d/2]*Gamma[1 + d/2]*Gamma[4 - aa$ + d/2]*
          ...
          (\[Delta][j3$, j2$]*\[Delta][j6$, j1$] + \[Delta][j3$, j1$]*
            \[Delta][j6$, j2$] + \[Delta][j2$, j1$]*\[Delta][j6$, j3$]))/
         (Gamma[aa$]*Gamma[5 - aa$ + d])) - k[LI[A1], j3$]*
       (-((2^(-2 - d)*Gamma[-1 + aa$ - d/2]*Gamma[1 + d/2]*
           Gamma[4 - aa$ + d/2]*k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^
            ((2*(1 + aa$) - d)/2)*(\[Delta][j4$, j2$]*\[Delta][j5$, j1$] + 
            \[Delta][j4$, j1$]*\[Delta][j5$, j2$] + \[Delta][j2$, j1$]*
             \[Delta][j5$, j4$]))/(Gamma[aa$]*Gamma[5 - aa$ + d])) - 
        (2^(-2 - d)*Gamma[-1 + aa$ - d/2]*Gamma[1 + d/2]*Gamma[4 - aa$ + d/2]*
          k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
          (\[Delta][j4$, j2$]*\[Delta][j6$, j1$] + \[Delta][j4$, j1$]*
            \[Delta][j6$, j2$] + \[Delta][j2$, j1$]*\[Delta][j6$, j4$]))/
       ...
       (-((2^(-2 - d)*Gamma[-1 + aa$ - d/2]*Gamma[1 + d/2]*
           Gamma[4 - aa$ + d/2]*k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^
            ((2*(1 + aa$) - d)/2)*(\[Delta][j4$, j3$]*\[Delta][j5$, j1$] + 
            \[Delta][j4$, j1$]*\[Delta][j5$, j3$] + \[Delta][j3$, j1$]*
             \[Delta][j5$, j4$]))/(Gamma[aa$]*Gamma[5 - aa$ + d])) - 
        (2^(-2 - d)*Gamma[-1 + aa$ - d/2]*Gamma[1 + d/2]*Gamma[4 - aa$ + d/2]*
          k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
       ...
       (-((2^(-2 - d)*Gamma[-1 + aa$ - d/2]*Gamma[1 + d/2]*
           Gamma[4 - aa$ + d/2]*k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^
            ((2*(1 + aa$) - d)/2)*(\[Delta][j4$, j3$]*\[Delta][j5$, j2$] + 
            \[Delta][j4$, j2$]*\[Delta][j5$, j3$] + \[Delta][j3$, j2$]*
             \[Delta][j5$, j4$]))/(Gamma[aa$]*Gamma[5 - aa$ + d])) - 
        (2^(-2 - d)*Gamma[-1 + aa$ - d/2]*Gamma[1 + d/2]*Gamma[4 - aa$ + d/2]*
          k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
    ...
    ((2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[5 - aa$ + d/2]*Gamma[d/2]*
       ...
       (-((2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[5 - aa$ + d/2]*Gamma[d/2]*
           k[LI[A1], j4$]*k[LI[A1], j5$]*k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^
            ((2*(1 + aa$) - d)/2)*\[Delta][j3$, j1$])/(Gamma[aa$]*
           Gamma[5 - aa$ + d])) - k[LI[A1], j3$]*
         ((2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[5 - aa$ + d/2]*Gamma[d/2]*
            k[LI[A1], j5$]*k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^
             ((2*(1 + aa$) - d)/2)*\[Delta][j4$, j1$])/(Gamma[aa$]*
            Gamma[5 - aa$ + d]) - k[LI[A1], j4$]*
           (-((2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[5 - aa$ + d/2]*Gamma[d/2]*k[
                LI[A1], j6$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
               \[Delta][j5$, j1$])/(Gamma[aa$]*Gamma[5 - aa$ + d])) - 
            (2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[5 - aa$ + d/2]*Gamma[d/2]*
              k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*
              \[Delta][j6$, j1$])/(Gamma[aa$]*Gamma[5 - aa$ + d])))) - 
        ...
        k[LI[A1], j2$]*((2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[5 - aa$ + d/2]*
           ...
           (-((2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[5 - aa$ + d/2]*Gamma[d/2]*k[
            ...
            (2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[5 - aa$ + d/2]*Gamma[d/2]*
              ...
              \[Delta][j6$, j3$])/(Gamma[aa$]*Gamma[5 - aa$ + d])) - 
          k[LI[A1], j3$]*(-((2^(-1 - d)*Gamma[aa$ - d/2]*Gamma[5 - aa$ + d/2]*
               Gamma[d/2]*k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^
                ((2*(1 + aa$) - d)/2)*\[Delta][j5$, j4$])/(Gamma[aa$]*Gamma[
                5 - aa$ + d])) - (2^(-1 - d)*Gamma[aa$ - d/2]*
              Gamma[5 - aa$ + d/2]*Gamma[d/2]*k[LI[A1], j5$]*
              prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*\[Delta][j6$, j4$])/
             (Gamma[aa$]*Gamma[5 - aa$ + d]) - (2^(-1 - d)*Gamma[aa$ - d/2]*
              Gamma[5 - aa$ + d/2]*Gamma[d/2]*k[LI[A1], j4$]*
              prop[ks[LI[A1]]^2]^((2*(1 + aa$) - d)/2)*\[Delta][j6$, j5$])/
             (Gamma[aa$]*Gamma[5 - aa$ + d])))))/prop[ks[LI[A1]]^2])/
   Pi^(d/2), Int[dd[ks[LI[A_]]]*prop[ks[LI[A_]]^2]^(aa$_)*
    prop[(ks[LI[A_]] + ks[LI[A1_]])^2]^(bb$_)] -> 
  (Gamma[aa$ + bb$ - d/2]*Gamma[-aa$ + d/2]*Gamma[-bb$ + d/2]*
    prop[ks[LI[A1]]^2]^(aa$ + bb$ - d/2))/(2^d*Pi^(d/2)*Gamma[aa$]*Gamma[bb$]*
    Gamma[-aa$ - bb$ + d]), 
 Int[dd[ks[LI[A_]]]*k[LI[A_], j1$_]*prop[ks[LI[A_]]^2]^(aa$_)*
    prop[(ks[LI[A_]] + ks[LI[A1_]])^2]^(bb$_)] -> 
  -((Gamma[aa$ + bb$ - d/2]*Gamma[1 - aa$ + d/2]*Gamma[-bb$ + d/2]*
     k[LI[A1], j1$]*prop[ks[LI[A1]]^2]^((2*(aa$ + bb$) - d)/2))/
    (2^d*Pi^(d/2)*Gamma[aa$]*Gamma[bb$]*Gamma[1 - aa$ - bb$ + d])), 
 Int[dd[ks[LI[A_]]]*k[LI[A_], j1$_]*k[LI[A_], j2$_]*prop[ks[LI[A_]]^2]^(aa$_)*
    prop[(ks[LI[A_]] + ks[LI[A1_]])^2]^(bb$_)] -> 
  ((Gamma[aa$ + bb$ - d/2]*Gamma[2 - aa$ + d/2]*Gamma[-bb$ + d/2]*
      k[LI[A1], j1$]*k[LI[A1], j2$]*prop[ks[LI[A1]]^2]^
       ((2*(aa$ + bb$) - d)/2))/(2^d*Gamma[aa$]*Gamma[bb$]*
      Gamma[2 - aa$ - bb$ + d]) + (2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*
      Gamma[1 - aa$ + d/2]*Gamma[1 - bb$ + d/2]*prop[ks[LI[A1]]^2]^
       (-1 + (2*(aa$ + bb$) - d)/2)*\[Delta][j2$, j1$])/
     (Gamma[aa$]*Gamma[bb$]*Gamma[2 - aa$ - bb$ + d]))/Pi^(d/2), 
 Int[dd[ks[LI[A_]]]*k[LI[A_], j1$_]*k[LI[A_], j2$_]*k[LI[A_], j3$_]*
    prop[ks[LI[A_]]^2]^(aa$_)*prop[(ks[LI[A_]] + ks[LI[A1_]])^2]^(bb$_)] -> 
  (-((Gamma[aa$ + bb$ - d/2]*Gamma[3 - aa$ + d/2]*Gamma[-bb$ + d/2]*
       k[LI[A1], j1$]*k[LI[A1], j2$]*k[LI[A1], j3$]*prop[ks[LI[A1]]^2]^
        ((2*(aa$ + bb$) - d)/2))/(2^d*Gamma[aa$]*Gamma[bb$]*
       Gamma[3 - aa$ - bb$ + d])) + 
    (-((2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*Gamma[2 - aa$ + d/2]*
         Gamma[1 - bb$ + d/2]*k[LI[A1], j3$]*prop[ks[LI[A1]]^2]^
          ((2*(aa$ + bb$) - d)/2)*\[Delta][j2$, j1$])/(Gamma[aa$]*Gamma[bb$]*
         Gamma[3 - aa$ - bb$ + d])) - (2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*
        Gamma[2 - aa$ + d/2]*Gamma[1 - bb$ + d/2]*k[LI[A1], j2$]*
        prop[ks[LI[A1]]^2]^((2*(aa$ + bb$) - d)/2)*\[Delta][j3$, j1$])/
       (Gamma[aa$]*Gamma[bb$]*Gamma[3 - aa$ - bb$ + d]) - 
      (2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*Gamma[2 - aa$ + d/2]*
        Gamma[1 - bb$ + d/2]*k[LI[A1], j1$]*prop[ks[LI[A1]]^2]^
         ((2*(aa$ + bb$) - d)/2)*\[Delta][j3$, j2$])/(Gamma[aa$]*Gamma[bb$]*
        Gamma[3 - aa$ - bb$ + d]))/prop[ks[LI[A1]]^2])/Pi^(d/2), 
 Int[dd[ks[LI[A_]]]*k[LI[A_], j1$_]*k[LI[A_], j2$_]*k[LI[A_], j3$_]*
    k[LI[A_], j4$_]*prop[ks[LI[A_]]^2]^(aa$_)*
    prop[(ks[LI[A_]] + ks[LI[A1_]])^2]^(bb$_)] -> 
  ((Gamma[aa$ + bb$ - d/2]*Gamma[4 - aa$ + d/2]*Gamma[-bb$ + d/2]*
      k[LI[A1], j1$]*k[LI[A1], j2$]*k[LI[A1], j3$]*k[LI[A1], j4$]*
      prop[ks[LI[A1]]^2]^((2*(aa$ + bb$) - d)/2))/(2^d*Gamma[aa$]*Gamma[bb$]*
      Gamma[4 - aa$ - bb$ + d]) + (2^(-2 - d)*Gamma[-2 + aa$ + bb$ - d/2]*
      Gamma[2 - aa$ + d/2]*Gamma[2 - bb$ + d/2]*prop[ks[LI[A1]]^2]^
       (-2 + (2*(aa$ + bb$) - d)/2)*(\[Delta][j3$, j2$]*\[Delta][j4$, j1$] + 
       \[Delta][j3$, j1$]*\[Delta][j4$, j2$] + \[Delta][j2$, j1$]*
        \[Delta][j4$, j3$]))/(Gamma[aa$]*Gamma[bb$]*
      Gamma[4 - aa$ - bb$ + d]) + 
    ((2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*Gamma[3 - aa$ + d/2]*
        Gamma[1 - bb$ + d/2]*k[LI[A1], j3$]*k[LI[A1], j4$]*
        prop[ks[LI[A1]]^2]^((2*(aa$ + bb$) - d)/2)*\[Delta][j2$, j1$])/
       (Gamma[aa$]*Gamma[bb$]*Gamma[4 - aa$ - bb$ + d]) + 
      k[LI[A1], j2$]*((2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*
          Gamma[3 - aa$ + d/2]*Gamma[1 - bb$ + d/2]*k[LI[A1], j4$]*
          prop[ks[LI[A1]]^2]^((2*(aa$ + bb$) - d)/2)*\[Delta][j3$, j1$])/
         (Gamma[aa$]*Gamma[bb$]*Gamma[4 - aa$ - bb$ + d]) + 
        (2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*Gamma[3 - aa$ + d/2]*
          Gamma[1 - bb$ + d/2]*k[LI[A1], j3$]*prop[ks[LI[A1]]^2]^
           ((2*(aa$ + bb$) - d)/2)*\[Delta][j4$, j1$])/(Gamma[aa$]*Gamma[bb$]*
          Gamma[4 - aa$ - bb$ + d])) + k[LI[A1], j1$]*
       ((2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*Gamma[3 - aa$ + d/2]*
          Gamma[1 - bb$ + d/2]*k[LI[A1], j4$]*prop[ks[LI[A1]]^2]^
           ((2*(aa$ + bb$) - d)/2)*\[Delta][j3$, j2$])/(Gamma[aa$]*Gamma[bb$]*
          Gamma[4 - aa$ - bb$ + d]) + (2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*
          Gamma[3 - aa$ + d/2]*Gamma[1 - bb$ + d/2]*k[LI[A1], j3$]*
          prop[ks[LI[A1]]^2]^((2*(aa$ + bb$) - d)/2)*\[Delta][j4$, j2$])/
         (Gamma[aa$]*Gamma[bb$]*Gamma[4 - aa$ - bb$ + d]) + 
        (2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*Gamma[3 - aa$ + d/2]*
          Gamma[1 - bb$ + d/2]*k[LI[A1], j2$]*prop[ks[LI[A1]]^2]^
           ((2*(aa$ + bb$) - d)/2)*\[Delta][j4$, j3$])/(Gamma[aa$]*Gamma[bb$]*
          Gamma[4 - aa$ - bb$ + d])))/prop[ks[LI[A1]]^2])/Pi^(d/2), 
 Int[dd[ks[LI[A_]]]*k[LI[A_], j1$_]*k[LI[A_], j2$_]*k[LI[A_], j3$_]*
    k[LI[A_], j4$_]*k[LI[A_], j5$_]*prop[ks[LI[A_]]^2]^(aa$_)*
    prop[(ks[LI[A_]] + ks[LI[A1_]])^2]^(bb$_)] -> 
  (-((Gamma[aa$ + bb$ - d/2]*Gamma[5 - aa$ + d/2]*Gamma[-bb$ + d/2]*
       k[LI[A1], j1$]*k[LI[A1], j2$]*k[LI[A1], j3$]*k[LI[A1], j4$]*
       k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^((2*(aa$ + bb$) - d)/2))/
      (2^d*Gamma[aa$]*Gamma[bb$]*Gamma[5 - aa$ - bb$ + d])) + 
    (-((2^(-2 - d)*Gamma[-2 + aa$ + bb$ - d/2]*Gamma[3 - aa$ + d/2]*
         Gamma[2 - bb$ + d/2]*k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^
          ((2*(aa$ + bb$) - d)/2)*(\[Delta][j3$, j2$]*\[Delta][j4$, j1$] + 
          \[Delta][j3$, j1$]*\[Delta][j4$, j2$] + \[Delta][j2$, j1$]*
           \[Delta][j4$, j3$]))/(Gamma[aa$]*Gamma[bb$]*
         Gamma[5 - aa$ - bb$ + d])) - (2^(-2 - d)*Gamma[-2 + aa$ + bb$ - d/2]*
        Gamma[3 - aa$ + d/2]*Gamma[2 - bb$ + d/2]*k[LI[A1], j4$]*
        prop[ks[LI[A1]]^2]^((2*(aa$ + bb$) - d)/2)*
        (\[Delta][j3$, j2$]*\[Delta][j5$, j1$] + \[Delta][j3$, j1$]*
          \[Delta][j5$, j2$] + \[Delta][j2$, j1$]*\[Delta][j5$, j3$]))/
       (Gamma[aa$]*Gamma[bb$]*Gamma[5 - aa$ - bb$ + d]) - 
      (2^(-2 - d)*Gamma[-2 + aa$ + bb$ - d/2]*Gamma[3 - aa$ + d/2]*
        Gamma[2 - bb$ + d/2]*k[LI[A1], j3$]*prop[ks[LI[A1]]^2]^
         ((2*(aa$ + bb$) - d)/2)*(\[Delta][j4$, j2$]*\[Delta][j5$, j1$] + 
         \[Delta][j4$, j1$]*\[Delta][j5$, j2$] + \[Delta][j2$, j1$]*
          \[Delta][j5$, j4$]))/(Gamma[aa$]*Gamma[bb$]*
        Gamma[5 - aa$ - bb$ + d]) - (2^(-2 - d)*Gamma[-2 + aa$ + bb$ - d/2]*
        Gamma[3 - aa$ + d/2]*Gamma[2 - bb$ + d/2]*k[LI[A1], j2$]*
        prop[ks[LI[A1]]^2]^((2*(aa$ + bb$) - d)/2)*
        (\[Delta][j4$, j3$]*\[Delta][j5$, j1$] + \[Delta][j4$, j1$]*
          \[Delta][j5$, j3$] + \[Delta][j3$, j1$]*\[Delta][j5$, j4$]))/
       (Gamma[aa$]*Gamma[bb$]*Gamma[5 - aa$ - bb$ + d]) - 
      (2^(-2 - d)*Gamma[-2 + aa$ + bb$ - d/2]*Gamma[3 - aa$ + d/2]*
        Gamma[2 - bb$ + d/2]*k[LI[A1], j1$]*prop[ks[LI[A1]]^2]^
         ((2*(aa$ + bb$) - d)/2)*(\[Delta][j4$, j3$]*\[Delta][j5$, j2$] + 
         \[Delta][j4$, j2$]*\[Delta][j5$, j3$] + \[Delta][j3$, j2$]*
          \[Delta][j5$, j4$]))/(Gamma[aa$]*Gamma[bb$]*
        Gamma[5 - aa$ - bb$ + d]))/prop[ks[LI[A1]]^2]^2 + 
    (-((2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*Gamma[4 - aa$ + d/2]*
         Gamma[1 - bb$ + d/2]*k[LI[A1], j3$]*k[LI[A1], j4$]*k[LI[A1], j5$]*
         prop[ks[LI[A1]]^2]^((2*(aa$ + bb$) - d)/2)*\[Delta][j2$, j1$])/
        (Gamma[aa$]*Gamma[bb$]*Gamma[5 - aa$ - bb$ + d])) + 
      k[LI[A1], j2$]*(-((2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*
           Gamma[4 - aa$ + d/2]*Gamma[1 - bb$ + d/2]*k[LI[A1], j4$]*
           k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^((2*(aa$ + bb$) - d)/2)*
           \[Delta][j3$, j1$])/(Gamma[aa$]*Gamma[bb$]*
           Gamma[5 - aa$ - bb$ + d])) + k[LI[A1], j3$]*
         (-((2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*Gamma[4 - aa$ + d/2]*
             Gamma[1 - bb$ + d/2]*k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^
              ((2*(aa$ + bb$) - d)/2)*\[Delta][j4$, j1$])/
            (Gamma[aa$]*Gamma[bb$]*Gamma[5 - aa$ - bb$ + d])) - 
          (2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*Gamma[4 - aa$ + d/2]*
            Gamma[1 - bb$ + d/2]*k[LI[A1], j4$]*prop[ks[LI[A1]]^2]^
             ((2*(aa$ + bb$) - d)/2)*\[Delta][j5$, j1$])/
           (Gamma[aa$]*Gamma[bb$]*Gamma[5 - aa$ - bb$ + d]))) + 
      k[LI[A1], j1$]*(-((2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*
           Gamma[4 - aa$ + d/2]*Gamma[1 - bb$ + d/2]*k[LI[A1], j4$]*
           k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^((2*(aa$ + bb$) - d)/2)*
           \[Delta][j3$, j2$])/(Gamma[aa$]*Gamma[bb$]*
           Gamma[5 - aa$ - bb$ + d])) + k[LI[A1], j3$]*
         (-((2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*Gamma[4 - aa$ + d/2]*
             Gamma[1 - bb$ + d/2]*k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^
              ((2*(aa$ + bb$) - d)/2)*\[Delta][j4$, j2$])/
            (Gamma[aa$]*Gamma[bb$]*Gamma[5 - aa$ - bb$ + d])) - 
          (2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*Gamma[4 - aa$ + d/2]*
            Gamma[1 - bb$ + d/2]*k[LI[A1], j4$]*prop[ks[LI[A1]]^2]^
             ((2*(aa$ + bb$) - d)/2)*\[Delta][j5$, j2$])/
           (Gamma[aa$]*Gamma[bb$]*Gamma[5 - aa$ - bb$ + d])) + 
        k[LI[A1], j2$]*(-((2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*
             Gamma[4 - aa$ + d/2]*Gamma[1 - bb$ + d/2]*k[LI[A1], j5$]*
             prop[ks[LI[A1]]^2]^((2*(aa$ + bb$) - d)/2)*\[Delta][j4$, j3$])/
            (Gamma[aa$]*Gamma[bb$]*Gamma[5 - aa$ - bb$ + d])) - 
          (2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*Gamma[4 - aa$ + d/2]*
            Gamma[1 - bb$ + d/2]*k[LI[A1], j4$]*prop[ks[LI[A1]]^2]^
             ((2*(aa$ + bb$) - d)/2)*\[Delta][j5$, j3$])/
           (Gamma[aa$]*Gamma[bb$]*Gamma[5 - aa$ - bb$ + d]) - 
          (2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*Gamma[4 - aa$ + d/2]*
            Gamma[1 - bb$ + d/2]*k[LI[A1], j3$]*prop[ks[LI[A1]]^2]^
             ((2*(aa$ + bb$) - d)/2)*\[Delta][j5$, j4$])/
           (Gamma[aa$]*Gamma[bb$]*Gamma[5 - aa$ - bb$ + d]))))/
     prop[ks[LI[A1]]^2])/Pi^(d/2), 
 Int[dd[ks[LI[A_]]]*k[LI[A_], j1$_]*k[LI[A_], j2$_]*k[LI[A_], j3$_]*
    k[LI[A_], j4$_]*k[LI[A_], j5$_]*k[LI[A_], j6$_]*prop[ks[LI[A_]]^2]^(aa$_)*
    prop[(ks[LI[A_]] + ks[LI[A1_]])^2]^(bb$_)] -> 
  ((Gamma[aa$ + bb$ - d/2]*Gamma[6 - aa$ + d/2]*Gamma[-bb$ + d/2]*
      k[LI[A1], j1$]*k[LI[A1], j2$]*k[LI[A1], j3$]*k[LI[A1], j4$]*
      k[LI[A1], j5$]*k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^
       ((2*(aa$ + bb$) - d)/2))/(2^d*Gamma[aa$]*Gamma[bb$]*
      Gamma[6 - aa$ - bb$ + d]) + (2^(-3 - d)*Gamma[-3 + aa$ + bb$ - d/2]*
      Gamma[3 - aa$ + d/2]*Gamma[3 - bb$ + d/2]*prop[ks[LI[A1]]^2]^
       (-3 + (2*(aa$ + bb$) - d)/2)*(\[Delta][j3$, j2$]*\[Delta][j5$, j4$]*
        \[Delta][j6$, j1$] + \[Delta][j3$, j1$]*\[Delta][j5$, j4$]*
        \[Delta][j6$, j2$] + \[Delta][j2$, j1$]*\[Delta][j5$, j4$]*
        \[Delta][j6$, j3$] + \[Delta][j4$, j1$]*
        (\[Delta][j5$, j3$]*\[Delta][j6$, j2$] + \[Delta][j5$, j2$]*
       ...
       \[Delta][j4$, j2$]*(\[Delta][j5$, j3$]*\[Delta][j6$, j1$] + 
         \[Delta][j5$, j1$]*\[Delta][j6$, j3$] + \[Delta][j3$, j1$]*
          \[Delta][j6$, j5$])))/(Gamma[aa$]*Gamma[bb$]*
      Gamma[6 - aa$ - bb$ + d]) + 
    ((2^(-2 - d)*Gamma[-2 + aa$ + bb$ - d/2]*Gamma[4 - aa$ + d/2]*
        Gamma[2 - bb$ + d/2]*k[LI[A1], j5$]*k[LI[A1], j6$]*
        prop[ks[LI[A1]]^2]^((2*(aa$ + bb$) - d)/2)*
        (\[Delta][j3$, j2$]*\[Delta][j4$, j1$] + \[Delta][j3$, j1$]*
          \[Delta][j4$, j2$] + \[Delta][j2$, j1$]*\[Delta][j4$, j3$]))/
       (Gamma[aa$]*Gamma[bb$]*Gamma[6 - aa$ - bb$ + d]) + 
      k[LI[A1], j4$]*((2^(-2 - d)*Gamma[-2 + aa$ + bb$ - d/2]*
          Gamma[4 - aa$ + d/2]*Gamma[2 - bb$ + d/2]*k[LI[A1], j6$]*
          prop[ks[LI[A1]]^2]^((2*(aa$ + bb$) - d)/2)*
          (\[Delta][j3$, j2$]*\[Delta][j5$, j1$] + \[Delta][j3$, j1$]*
            \[Delta][j5$, j2$] + \[Delta][j2$, j1$]*\[Delta][j5$, j3$]))/
         (Gamma[aa$]*Gamma[bb$]*Gamma[6 - aa$ - bb$ + d]) + 
        (2^(-2 - d)*Gamma[-2 + aa$ + bb$ - d/2]*Gamma[4 - aa$ + d/2]*
          Gamma[2 - bb$ + d/2]*k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^
           ((2*(aa$ + bb$) - d)/2)*(\[Delta][j3$, j2$]*\[Delta][j6$, j1$] + 
           \[Delta][j3$, j1$]*\[Delta][j6$, j2$] + \[Delta][j2$, j1$]*
            \[Delta][j6$, j3$]))/(Gamma[aa$]*Gamma[bb$]*
          Gamma[6 - aa$ - bb$ + d])) + k[LI[A1], j3$]*
       ((2^(-2 - d)*Gamma[-2 + aa$ + bb$ - d/2]*Gamma[4 - aa$ + d/2]*
          Gamma[2 - bb$ + d/2]*k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^
           ((2*(aa$ + bb$) - d)/2)*(\[Delta][j4$, j2$]*\[Delta][j5$, j1$] + 
           \[Delta][j4$, j1$]*\[Delta][j5$, j2$] + \[Delta][j2$, j1$]*
            \[Delta][j5$, j4$]))/(Gamma[aa$]*Gamma[bb$]*
          Gamma[6 - aa$ - bb$ + d]) + (2^(-2 - d)*Gamma[-2 + aa$ + bb$ - d/2]*
          Gamma[4 - aa$ + d/2]*Gamma[2 - bb$ + d/2]*k[LI[A1], j5$]*
          prop[ks[LI[A1]]^2]^((2*(aa$ + bb$) - d)/2)*
          (\[Delta][j4$, j2$]*\[Delta][j6$, j1$] + \[Delta][j4$, j1$]*
            \[Delta][j6$, j2$] + \[Delta][j2$, j1$]*\[Delta][j6$, j4$]))/
         (Gamma[aa$]*Gamma[bb$]*Gamma[6 - aa$ - bb$ + d]) + 
        (2^(-2 - d)*Gamma[-2 + aa$ + bb$ - d/2]*Gamma[4 - aa$ + d/2]*
          Gamma[2 - bb$ + d/2]*k[LI[A1], j4$]*prop[ks[LI[A1]]^2]^
           ((2*(aa$ + bb$) - d)/2)*(\[Delta][j5$, j2$]*\[Delta][j6$, j1$] + 
           \[Delta][j5$, j1$]*\[Delta][j6$, j2$] + \[Delta][j2$, j1$]*
            \[Delta][j6$, j5$]))/(Gamma[aa$]*Gamma[bb$]*
          Gamma[6 - aa$ - bb$ + d])) + k[LI[A1], j2$]*
       ((2^(-2 - d)*Gamma[-2 + aa$ + bb$ - d/2]*Gamma[4 - aa$ + d/2]*
          Gamma[2 - bb$ + d/2]*k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^
           ((2*(aa$ + bb$) - d)/2)*(\[Delta][j4$, j3$]*\[Delta][j5$, j1$] + 
           \[Delta][j4$, j1$]*\[Delta][j5$, j3$] + \[Delta][j3$, j1$]*
            \[Delta][j5$, j4$]))/(Gamma[aa$]*Gamma[bb$]*
          Gamma[6 - aa$ - bb$ + d]) + (2^(-2 - d)*Gamma[-2 + aa$ + bb$ - d/2]*
          Gamma[4 - aa$ + d/2]*Gamma[2 - bb$ + d/2]*k[LI[A1], j5$]*
        ...
        (2^(-2 - d)*Gamma[-2 + aa$ + bb$ - d/2]*Gamma[4 - aa$ + d/2]*
          Gamma[2 - bb$ + d/2]*k[LI[A1], j4$]*prop[ks[LI[A1]]^2]^
           ((2*(aa$ + bb$) - d)/2)*(\[Delta][j5$, j3$]*\[Delta][j6$, j1$] + 
           \[Delta][j5$, j1$]*\[Delta][j6$, j3$] + \[Delta][j3$, j1$]*
            \[Delta][j6$, j5$]))/(Gamma[aa$]*Gamma[bb$]*
          Gamma[6 - aa$ - bb$ + d]) + (2^(-2 - d)*Gamma[-2 + aa$ + bb$ - d/2]*
          Gamma[4 - aa$ + d/2]*Gamma[2 - bb$ + d/2]*k[LI[A1], j3$]*
          prop[ks[LI[A1]]^2]^((2*(aa$ + bb$) - d)/2)*
          (\[Delta][j5$, j4$]*\[Delta][j6$, j1$] + \[Delta][j5$, j1$]*
            \[Delta][j6$, j4$] + \[Delta][j4$, j1$]*\[Delta][j6$, j5$]))/
         (Gamma[aa$]*Gamma[bb$]*Gamma[6 - aa$ - bb$ + d])) + 
      k[LI[A1], j1$]*((2^(-2 - d)*Gamma[-2 + aa$ + bb$ - d/2]*
          Gamma[4 - aa$ + d/2]*Gamma[2 - bb$ + d/2]*k[LI[A1], j6$]*
          prop[ks[LI[A1]]^2]^((2*(aa$ + bb$) - d)/2)*
          (\[Delta][j4$, j3$]*\[Delta][j5$, j2$] + \[Delta][j4$, j2$]*
            \[Delta][j5$, j3$] + \[Delta][j3$, j2$]*\[Delta][j5$, j4$]))/
        ...
        (2^(-2 - d)*Gamma[-2 + aa$ + bb$ - d/2]*Gamma[4 - aa$ + d/2]*
          Gamma[2 - bb$ + d/2]*k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^
           ((2*(aa$ + bb$) - d)/2)*(\[Delta][j4$, j3$]*\[Delta][j6$, j2$] + 
           \[Delta][j4$, j2$]*\[Delta][j6$, j3$] + \[Delta][j3$, j2$]*
            \[Delta][j6$, j4$]))/(Gamma[aa$]*Gamma[bb$]*
          Gamma[6 - aa$ - bb$ + d]) + (2^(-2 - d)*Gamma[-2 + aa$ + bb$ - d/2]*
          Gamma[4 - aa$ + d/2]*Gamma[2 - bb$ + d/2]*k[LI[A1], j4$]*
          prop[ks[LI[A1]]^2]^((2*(aa$ + bb$) - d)/2)*
          (\[Delta][j5$, j3$]*\[Delta][j6$, j2$] + \[Delta][j5$, j2$]*
            \[Delta][j6$, j3$] + \[Delta][j3$, j2$]*\[Delta][j6$, j5$]))/
         (Gamma[aa$]*Gamma[bb$]*Gamma[6 - aa$ - bb$ + d]) + 
        (2^(-2 - d)*Gamma[-2 + aa$ + bb$ - d/2]*Gamma[4 - aa$ + d/2]*
          Gamma[2 - bb$ + d/2]*k[LI[A1], j3$]*prop[ks[LI[A1]]^2]^
           ((2*(aa$ + bb$) - d)/2)*(\[Delta][j5$, j4$]*\[Delta][j6$, j2$] + 
           \[Delta][j5$, j2$]*\[Delta][j6$, j4$] + \[Delta][j4$, j2$]*
            \[Delta][j6$, j5$]))/(Gamma[aa$]*Gamma[bb$]*
          Gamma[6 - aa$ - bb$ + d]) + (2^(-2 - d)*Gamma[-2 + aa$ + bb$ - d/2]*
          Gamma[4 - aa$ + d/2]*Gamma[2 - bb$ + d/2]*k[LI[A1], j2$]*
          prop[ks[LI[A1]]^2]^((2*(aa$ + bb$) - d)/2)*
          (\[Delta][j5$, j4$]*\[Delta][j6$, j3$] + \[Delta][j5$, j3$]*
            \[Delta][j6$, j4$] + \[Delta][j4$, j3$]*\[Delta][j6$, j5$]))/
         (Gamma[aa$]*Gamma[bb$]*Gamma[6 - aa$ - bb$ + d])))/
     prop[ks[LI[A1]]^2]^2 + 
    ((2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*Gamma[5 - aa$ + d/2]*
        Gamma[1 - bb$ + d/2]*k[LI[A1], j3$]*k[LI[A1], j4$]*k[LI[A1], j5$]*
        k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^((2*(aa$ + bb$) - d)/2)*
        \[Delta][j2$, j1$])/(Gamma[aa$]*Gamma[bb$]*
        Gamma[6 - aa$ - bb$ + d]) + k[LI[A1], j2$]*
       ((2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*Gamma[5 - aa$ + d/2]*
          Gamma[1 - bb$ + d/2]*k[LI[A1], j4$]*k[LI[A1], j5$]*k[LI[A1], j6$]*
          prop[ks[LI[A1]]^2]^((2*(aa$ + bb$) - d)/2)*\[Delta][j3$, j1$])/
         (Gamma[aa$]*Gamma[bb$]*Gamma[6 - aa$ - bb$ + d]) + 
        k[LI[A1], j3$]*((2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*
            Gamma[5 - aa$ + d/2]*Gamma[1 - bb$ + d/2]*k[LI[A1], j5$]*
            k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^((2*(aa$ + bb$) - d)/2)*
            \[Delta][j4$, j1$])/(Gamma[aa$]*Gamma[bb$]*
            Gamma[6 - aa$ - bb$ + d]) + k[LI[A1], j4$]*
           ((2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*Gamma[5 - aa$ + d/2]*
              Gamma[1 - bb$ + d/2]*k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^(
                (2*(aa$ + bb$) - d)/2)*\[Delta][j5$, j1$])/
             (Gamma[aa$]*Gamma[bb$]*Gamma[6 - aa$ - bb$ + d]) + 
            (2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*Gamma[5 - aa$ + d/2]*
              Gamma[1 - bb$ + d/2]*k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^(
                (2*(aa$ + bb$) - d)/2)*\[Delta][j6$, j1$])/
             (Gamma[aa$]*Gamma[bb$]*Gamma[6 - aa$ - bb$ + d])))) + 
      k[LI[A1], j1$]*((2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*
          Gamma[5 - aa$ + d/2]*Gamma[1 - bb$ + d/2]*k[LI[A1], j4$]*
          k[LI[A1], j5$]*k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^
           ((2*(aa$ + bb$) - d)/2)*\[Delta][j3$, j2$])/(Gamma[aa$]*Gamma[bb$]*
          Gamma[6 - aa$ - bb$ + d]) + k[LI[A1], j3$]*
         ((2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*Gamma[5 - aa$ + d/2]*
            ...
            prop[ks[LI[A1]]^2]^((2*(aa$ + bb$) - d)/2)*\[Delta][j4$, j2$])/
           (Gamma[aa$]*Gamma[bb$]*Gamma[6 - aa$ - bb$ + d]) + 
          k[LI[A1], j4$]*((2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*
              Gamma[5 - aa$ + d/2]*Gamma[1 - bb$ + d/2]*k[LI[A1], j6$]*
              prop[ks[LI[A1]]^2]^((2*(aa$ + bb$) - d)/2)*\[Delta][j5$, j2$])/
             (Gamma[aa$]*Gamma[bb$]*Gamma[6 - aa$ - bb$ + d]) + 
            (2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*Gamma[5 - aa$ + d/2]*
              Gamma[1 - bb$ + d/2]*k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^(
                (2*(aa$ + bb$) - d)/2)*\[Delta][j6$, j2$])/
             (Gamma[aa$]*Gamma[bb$]*Gamma[6 - aa$ - bb$ + d]))) + 
        k[LI[A1], j2$]*((2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*
            Gamma[5 - aa$ + d/2]*Gamma[1 - bb$ + d/2]*k[LI[A1], j5$]*
            k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^((2*(aa$ + bb$) - d)/2)*
           ...
           ((2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*Gamma[5 - aa$ + d/2]*
            ...
            (2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*Gamma[5 - aa$ + d/2]*
              Gamma[1 - bb$ + d/2]*k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^(
                (2*(aa$ + bb$) - d)/2)*\[Delta][j6$, j3$])/
             (Gamma[aa$]*Gamma[bb$]*Gamma[6 - aa$ - bb$ + d])) + 
          k[LI[A1], j3$]*((2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*
              Gamma[5 - aa$ + d/2]*Gamma[1 - bb$ + d/2]*k[LI[A1], j6$]*
              prop[ks[LI[A1]]^2]^((2*(aa$ + bb$) - d)/2)*\[Delta][j5$, j4$])/
             (Gamma[aa$]*Gamma[bb$]*Gamma[6 - aa$ - bb$ + d]) + 
            (2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*Gamma[5 - aa$ + d/2]*
              Gamma[1 - bb$ + d/2]*k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^(
                (2*(aa$ + bb$) - d)/2)*\[Delta][j6$, j4$])/
             (Gamma[aa$]*Gamma[bb$]*Gamma[6 - aa$ - bb$ + d]) + 
            (2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*Gamma[5 - aa$ + d/2]*
              Gamma[1 - bb$ + d/2]*k[LI[A1], j4$]*prop[ks[LI[A1]]^2]^(
                (2*(aa$ + bb$) - d)/2)*\[Delta][j6$, j5$])/
             (Gamma[aa$]*Gamma[bb$]*Gamma[6 - aa$ - bb$ + d])))))/
     prop[ks[LI[A1]]^2])/Pi^(d/2), 
 Int[dd[ks[LI[A_]]]*prop[ks[LI[A_]]^2]^(aa$_)*
    prop[(ks[LI[A_]] - ks[LI[A1_]])^2]^(bb$_)] -> 
  ...
  ((Gamma[aa$ + bb$ - d/2]*Gamma[4 - aa$ + d/2]*Gamma[-bb$ + d/2]*
    ...
    ((2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*Gamma[3 - aa$ + d/2]*
      ...
      k[LI[A1], j2$]*(-((2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*
       ...
       (-((2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*Gamma[3 - aa$ + d/2]*
           Gamma[1 - bb$ + d/2]*k[LI[A1], j4$]*prop[ks[LI[A1]]^2]^
            ((2*(aa$ + bb$) - d)/2)*\[Delta][j3$, j2$])/
          (Gamma[aa$]*Gamma[bb$]*Gamma[4 - aa$ - bb$ + d])) - 
        (2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*Gamma[3 - aa$ + d/2]*
          Gamma[1 - bb$ + d/2]*k[LI[A1], j3$]*prop[ks[LI[A1]]^2]^
           ((2*(aa$ + bb$) - d)/2)*\[Delta][j4$, j2$])/(Gamma[aa$]*Gamma[bb$]*
          Gamma[4 - aa$ - bb$ + d]) - (2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*
          Gamma[3 - aa$ + d/2]*Gamma[1 - bb$ + d/2]*k[LI[A1], j2$]*
          prop[ks[LI[A1]]^2]^((2*(aa$ + bb$) - d)/2)*\[Delta][j4$, j3$])/
         (Gamma[aa$]*Gamma[bb$]*Gamma[4 - aa$ - bb$ + d])))/
     prop[ks[LI[A1]]^2])/Pi^(d/2), 
 Int[dd[ks[LI[A_]]]*k[LI[A_], j1$_]*k[LI[A_], j2$_]*k[LI[A_], j3$_]*
    ...
    ((2^(-2 - d)*Gamma[-2 + aa$ + bb$ - d/2]*Gamma[4 - aa$ + d/2]*
      ...
      k[LI[A1], j4$]*(-((2^(-2 - d)*Gamma[-2 + aa$ + bb$ - d/2]*
       ...
       (-((2^(-2 - d)*Gamma[-2 + aa$ + bb$ - d/2]*Gamma[4 - aa$ + d/2]*
        ...
        (2^(-2 - d)*Gamma[-2 + aa$ + bb$ - d/2]*Gamma[4 - aa$ + d/2]*
          Gamma[2 - bb$ + d/2]*k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^
           ((2*(aa$ + bb$) - d)/2)*(\[Delta][j4$, j2$]*\[Delta][j6$, j1$] + 
           \[Delta][j4$, j1$]*\[Delta][j6$, j2$] + \[Delta][j2$, j1$]*
            \[Delta][j6$, j4$]))/(Gamma[aa$]*Gamma[bb$]*
          Gamma[6 - aa$ - bb$ + d]) - (2^(-2 - d)*Gamma[-2 + aa$ + bb$ - d/2]*
          Gamma[4 - aa$ + d/2]*Gamma[2 - bb$ + d/2]*k[LI[A1], j4$]*
          prop[ks[LI[A1]]^2]^((2*(aa$ + bb$) - d)/2)*
          (\[Delta][j5$, j2$]*\[Delta][j6$, j1$] + \[Delta][j5$, j1$]*
            \[Delta][j6$, j2$] + \[Delta][j2$, j1$]*\[Delta][j6$, j5$]))/
         (Gamma[aa$]*Gamma[bb$]*Gamma[6 - aa$ - bb$ + d])) - 
      k[LI[A1], j2$]*(-((2^(-2 - d)*Gamma[-2 + aa$ + bb$ - d/2]*
           Gamma[4 - aa$ + d/2]*Gamma[2 - bb$ + d/2]*k[LI[A1], j6$]*
           prop[ks[LI[A1]]^2]^((2*(aa$ + bb$) - d)/2)*
           (\[Delta][j4$, j3$]*\[Delta][j5$, j1$] + \[Delta][j4$, j1$]*
             \[Delta][j5$, j3$] + \[Delta][j3$, j1$]*\[Delta][j5$, j4$]))/
        ...
        (2^(-2 - d)*Gamma[-2 + aa$ + bb$ - d/2]*Gamma[4 - aa$ + d/2]*
          Gamma[2 - bb$ + d/2]*k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^
           ((2*(aa$ + bb$) - d)/2)*(\[Delta][j4$, j3$]*\[Delta][j6$, j1$] + 
           \[Delta][j4$, j1$]*\[Delta][j6$, j3$] + \[Delta][j3$, j1$]*
            \[Delta][j6$, j4$]))/(Gamma[aa$]*Gamma[bb$]*
          Gamma[6 - aa$ - bb$ + d]) - (2^(-2 - d)*Gamma[-2 + aa$ + bb$ - d/2]*
          Gamma[4 - aa$ + d/2]*Gamma[2 - bb$ + d/2]*k[LI[A1], j4$]*
          prop[ks[LI[A1]]^2]^((2*(aa$ + bb$) - d)/2)*
        ...
        (2^(-2 - d)*Gamma[-2 + aa$ + bb$ - d/2]*Gamma[4 - aa$ + d/2]*
          Gamma[2 - bb$ + d/2]*k[LI[A1], j3$]*prop[ks[LI[A1]]^2]^
           ((2*(aa$ + bb$) - d)/2)*(\[Delta][j5$, j4$]*\[Delta][j6$, j1$] + 
           \[Delta][j5$, j1$]*\[Delta][j6$, j4$] + \[Delta][j4$, j1$]*
            \[Delta][j6$, j5$]))/(Gamma[aa$]*Gamma[bb$]*
          Gamma[6 - aa$ - bb$ + d])) - k[LI[A1], j1$]*
       (-((2^(-2 - d)*Gamma[-2 + aa$ + bb$ - d/2]*Gamma[4 - aa$ + d/2]*
           Gamma[2 - bb$ + d/2]*k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^
            ((2*(aa$ + bb$) - d)/2)*(\[Delta][j4$, j3$]*\[Delta][j5$, j2$] + 
            \[Delta][j4$, j2$]*\[Delta][j5$, j3$] + \[Delta][j3$, j2$]*
    ...
    ((2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*Gamma[5 - aa$ + d/2]*
       ...
       (-((2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*Gamma[5 - aa$ + d/2]*
        ...
        k[LI[A1], j3$]*((2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*
           ...
           (-((2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*Gamma[5 - aa$ + d/2]*
               Gamma[1 - bb$ + d/2]*k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^
                ((2*(aa$ + bb$) - d)/2)*\[Delta][j5$, j1$])/(Gamma[aa$]*Gamma[
                bb$]*Gamma[6 - aa$ - bb$ + d])) - 
            (2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*Gamma[5 - aa$ + d/2]*
              Gamma[1 - bb$ + d/2]*k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^(
                (2*(aa$ + bb$) - d)/2)*\[Delta][j6$, j1$])/
      ...
      k[LI[A1], j1$]*(-((2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*
        ...
        k[LI[A1], j3$]*((2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*
            Gamma[5 - aa$ + d/2]*Gamma[1 - bb$ + d/2]*k[LI[A1], j5$]*
            k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^((2*(aa$ + bb$) - d)/2)*
            \[Delta][j4$, j2$])/(Gamma[aa$]*Gamma[bb$]*
            Gamma[6 - aa$ - bb$ + d]) - k[LI[A1], j4$]*
           (-((2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*Gamma[5 - aa$ + d/2]*
               Gamma[1 - bb$ + d/2]*k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^
                ((2*(aa$ + bb$) - d)/2)*\[Delta][j5$, j2$])/(Gamma[aa$]*Gamma[
                bb$]*Gamma[6 - aa$ - bb$ + d])) - 
            (2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*Gamma[5 - aa$ + d/2]*
              Gamma[1 - bb$ + d/2]*k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^(
                (2*(aa$ + bb$) - d)/2)*\[Delta][j6$, j2$])/
        ...
        k[LI[A1], j2$]*((2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*
           ...
           (-((2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*Gamma[5 - aa$ + d/2]*
               Gamma[1 - bb$ + d/2]*k[LI[A1], j6$]*prop[ks[LI[A1]]^2]^
                ((2*(aa$ + bb$) - d)/2)*\[Delta][j5$, j3$])/(Gamma[aa$]*Gamma[
                bb$]*Gamma[6 - aa$ - bb$ + d])) - 
            (2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*Gamma[5 - aa$ + d/2]*
              Gamma[1 - bb$ + d/2]*k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^(
                (2*(aa$ + bb$) - d)/2)*\[Delta][j6$, j3$])/
             (Gamma[aa$]*Gamma[bb$]*Gamma[6 - aa$ - bb$ + d])) - 
          k[LI[A1], j3$]*(-((2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*Gamma[
                5 - aa$ + d/2]*Gamma[1 - bb$ + d/2]*k[LI[A1], j6$]*
               prop[ks[LI[A1]]^2]^((2*(aa$ + bb$) - d)/2)*\[Delta][j5$, j4$])/
              (Gamma[aa$]*Gamma[bb$]*Gamma[6 - aa$ - bb$ + d])) - 
            (2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*Gamma[5 - aa$ + d/2]*
              Gamma[1 - bb$ + d/2]*k[LI[A1], j5$]*prop[ks[LI[A1]]^2]^(
            ...
            (2^(-1 - d)*Gamma[-1 + aa$ + bb$ - d/2]*Gamma[5 - aa$ + d/2]*
             ...
             (Gamma[aa$]*Gamma[bb$]*Gamma[6 - aa$ - bb$ + d])))))/
     prop[ks[LI[A1]]^2])/Pi^(d/2), 
 Int[dd[ks[A_]]*(kk___)*prop[ks[A_]^2]*prop[(ks[A_] + (X_) + (Y__))^2]] :> 
  Module[{Z, Zrule}, 
   Zrule = {(ks[p[Z]] /. {\[Alpha] -> aa$_, \[Beta] -> bb$_}) -> 
       (X + Y /. {\[Alpha] -> aa$, \[Beta] -> bb$})}; 
    Int[dd[ks[A]]*prop[ks[A]^2]^1*prop[(ks[A] + ks[p[Z]])^2]^1*kk] /. 
       masterJrules /. Zrule /. ksTok[Zrule]], 
 Int[dd[ks[A_]]*(kk___)*prop[ks[A_]^2]*prop[(ks[A_] + (X_) + (Y__))^2]^
     \[Beta]] :> Module[{Z, Zrule}, 
   Zrule = {(ks[p[Z]] /. {\[Alpha] -> aa$_, \[Beta] -> bb$_}) -> 
       (X + Y /. {\[Alpha] -> aa$, \[Beta] -> bb$})}; 
    Int[dd[ks[A]]*prop[ks[A]^2]^1*prop[(ks[A] + ks[p[Z]])^2]^\[Beta]*kk] /. 
       masterJrules /. Zrule /. ksTok[Zrule]], 
 Int[dd[ks[A_]]*(kk___)*prop[ks[A_]^2]^\[Alpha]*
    prop[(ks[A_] + (X_) + (Y__))^2]] :> Module[{Z, Zrule}, 
   Zrule = {(ks[p[Z]] /. {\[Alpha] -> aa$_, \[Beta] -> bb$_}) -> 
       (X + Y /. {\[Alpha] -> aa$, \[Beta] -> bb$})}; 
    Int[dd[ks[A]]*prop[ks[A]^2]^\[Alpha]*prop[(ks[A] + ks[p[Z]])^2]^1*kk] /. 
       masterJrules /. Zrule /. ksTok[Zrule]], 
 Int[dd[ks[A_]]*(kk___)*prop[ks[A_]^2]^\[Alpha]*
    prop[(ks[A_] + (X_) + (Y__))^2]^\[Beta]] :> 
  Module[{Z, Zrule}, 
   Zrule = {(ks[p[Z]] /. {\[Alpha] -> aa$_, \[Beta] -> bb$_}) -> 
       (X + Y /. {\[Alpha] -> aa$, \[Beta] -> bb$})}; 
    Int[dd[ks[A]]*prop[ks[A]^2]^\[Alpha]*prop[(ks[A] + ks[p[Z]])^2]^\[Beta]*
         kk] /. masterJrules /. Zrule /. ksTok[Zrule]], 
 ...
 Int[dd[ks[LI[A_]]]*dd[ks[LI[B_]]]*k[LI[B_], j1_]*k[LI[B_], j2_]*
  ...
  (2^(-1 - 3*d)*d*Pi^(7/2 - d)*Csc[(d*Pi)/2]^2*
   ...
   2^(-3 - 4*d)*Pi^(2 - d)*Csc[(d*Pi)/2]*
    ((16*(-3 - 3*d + d^2)*Cot[(d*Pi)/2]*Gamma[-2^(-1) - d/2])/
 ...
 Int[dd[ks[LI[A_]]]*dd[ks[LI[B_]]]*k[LI[A_], i1_]*k[LI[B_], j1_]*
  ...
  ((-2 + d)*Pi^(7/2 - d)*Csc[(d*Pi)/2]^3*k[LI[cc], i1]*k[LI[cc], j1]*
   ...
   (2^(3 - 4*d)*(-3 + d)*Pi^(3 - d)*Gamma[-4 + d]*k[LI[cc], i1]*
     ...
     prop[ks[LI[cc]]^2]^(3 - d)*
     (-(((-1 + d)*d*(-10 + (-1 + d)*d)*Pi^2*Cot[(d*Pi)/2]*
         Gamma[-2^(-1) - d/2])/((2 + d)*Gamma[(3 + d)/2])) + 
      (2^(3 + d)*Pi^(7/2)*(8*d*Gamma[2 - d/2]*Gamma[-1 + (3*d)/2] + 
         (4 + d - d^2)*Gamma[3 + d]*Sec[(d*Pi)/2]))/((1 + d)*(-1 + Cos[d*Pi])*
        Gamma[1 - d/2]*Gamma[2 - d/2]*Gamma[(-1 + d)/2]*Gamma[3 + d]*
        Gamma[-1 + (3*d)/2]))*
  ...
  2^(-1 - 3*d)*d*Pi^(5/2 - d)*Csc[(d*Pi)/2]^2*
   ...
   4^(-1 - 2*d)*Pi^(2 - d)*Csc[(d*Pi)/2]*prop[ks[LI[cc]]^2]^(3 - d)*
    (-(((-1 + d^2)*Pi*Csc[(d*Pi)/2])/((-2 + d)*Gamma[(3 + d)/2]^2)) + 
     ((-1 + d)*d*(-10 + (-1 + d)*d)*Cot[(d*Pi)/2]*Gamma[-2^(-1) - d/2])/
      ...
      k[LI[cc], j2]*(k[LI[cc], j5]*(\[Delta][j3, j1]*\[Delta][j4, i1] + 
       ...
       (k[LI[cc], j5]*(\[Delta][j3, j2]*\[Delta][j4, i1] + 
        ...
        k[LI[cc], j3]*(\[Delta][j4, j2]*\[Delta][j5, i1] + 
         ...
         (\[Delta][j4, j3]*\[Delta][j5, i1] + \[Delta][j4, i1]*
           \[Delta][j5, j3] + \[Delta][j3, i1]*\[Delta][j5, j4]))))/
    (3*8^d*(-4 + d)^2*d*(3 + d)*Gamma[(-1 + d)/2]*Gamma[-(d/2)]*
     Gamma[(3*d)/2]*Gamma[4 + d]), 
 Int[dd[ks[LI[A_]]]*dd[ks[LI[B_]]]*k[LI[A_], i1_]*k[LI[B_], j1_]*
    k[LI[B_], j2_]*k[LI[B_], j3_]*k[LI[B_], j4_]*k[LI[B_], j5_]*
    prop[ks[LI[A_]]^2]*prop[ks[LI[B_]]^2]*prop[(ks[LI[A_]] + ks[LI[B_]])^2]*
    prop[(ks[LI[A_]] - ks[LI[cc_]])^2]*prop[(ks[LI[B_]] + ks[LI[cc_]])^2]] :> 
 ...
 Int[dd[ks[LI[A_]]]*dd[ks[LI[B_]]]*k[LI[A_], i1_]*k[LI[A_], i2_]*
  ...
  (2^(-1 - 3*d)*(1 + d)*Pi^(5/2 - d)*Csc[(d*Pi)/2]^2*
   ...
   (2^(-3 - 4*d)*Csc[(d*Pi)/2]*(4*Pi^2*Cot[(d*Pi)/2]*Gamma[-2^(-1) - d/2] + 
 ...
 Int[dd[ks[LI[A_]]]*dd[ks[LI[B_]]]*k[LI[A_], i1_]*k[LI[A_], i2_]*
  ...
  -((2^(-1 - 3*d)*d*Pi^(7/2 - d)*Csc[(d*Pi)/2]^2*
    ...
    (2^(3 - 4*d)*Pi^(3 - d)*Csc[d*Pi]*((-16 + d*(4 + d*(6 + d - d^2)))*
        ...
        Gamma[-1 + (3*d)/2])*prop[ks[LI[cc]]^2]^(3 - d)*
      (\[Delta][j1, i2]*\[Delta][j2, i1] + \[Delta][j1, i1]*
        \[Delta][j2, i2]))/(d*(8 - 6*d + d^2)^2*Gamma[(-1 + d)/2]*
      Gamma[-(d/2)]*Gamma[(3 + d)/2]*Gamma[-1 + (3*d)/2]) + 
    2^(-5 - 2*d)*Pi^(2 - d)*Csc[(d*Pi)/2]*Gamma[-2 + d/2]*
     prop[ks[LI[cc]]^2]^(4 - d)*((32*Cot[(d*Pi)/2]*Gamma[-1 - d])/
       (Gamma[-1 - d/2]*Gamma[-1 + d]) + 
      (Pi*((4*(-2 + (-2 + d)*d))/(Gamma[2 - d/2]*Gamma[-2 + d]*Gamma[d]) + 
 ...
 Int[dd[ks[LI[A_]]]*dd[ks[LI[B_]]]*k[LI[A_], i1_]*k[LI[B_], j1_]*
  ...
  -(((-2 + d)*Pi^(7/2 - d)*Csc[(d*Pi)/2]^3*k[LI[cc], i1]*k[LI[cc], j1]*
    ...
    (Pi^(7/2 - d)*Csc[(d*Pi)/2]^2*(((-16 + d^2)*Csc[(d*Pi)/2])/
        Gamma[-2 + d] + (24*(-3 + d)*d^2*Csc[d*Pi])/(Gamma[-(d/2)]*
         Gamma[-1 + (3*d)/2]))*prop[ks[LI[cc]]^2]^(4 - d)*
    ...
    (2^(3 - 4*d)*(-3 + d)*Pi^(3 - d)*Gamma[-4 + d]*k[LI[cc], i1]*
      ...
      (-(((-1 + d)*d*(-10 + (-1 + d)*d)*Pi^2*Cot[(d*Pi)/2]*
          Gamma[-2^(-1) - d/2])/((2 + d)*Gamma[(3 + d)/2])) + 
       (2^(3 + d)*Pi^(7/2)*(8*d*Gamma[2 - d/2]*Gamma[-1 + (3*d)/2] + 
          (4 + d - d^2)*Gamma[3 + d]*Sec[(d*Pi)/2]))/
        ((1 + d)*(-1 + Cos[d*Pi])*Gamma[1 - d/2]*Gamma[2 - d/2]*
         Gamma[(-1 + d)/2]*Gamma[3 + d]*Gamma[-1 + (3*d)/2]))*
      (k[LI[cc], j4]*(\[Delta][j2, j1]*\[Delta][j3, i1] + 
         \[Delta][j2, i1]*\[Delta][j3, j1] + \[Delta][j1, i1]*
          \[Delta][j3, j2]) + k[LI[cc], j3]*
        (\[Delta][j2, j1]*\[Delta][j4, i1] + \[Delta][j2, i1]*
  ...
  -((2^(-1 - 3*d)*(1 + d)*Pi^(5/2 - d)*Csc[(d*Pi)/2]^2*
    ...
    (2^(-5 - 3*d)*Pi^(5/2 - d)*Csc[(d*Pi)/2]*
      ((256*Pi*Csc[(d*Pi)/2]^2)/(Gamma[-2 - d/2]*Gamma[(-1 + d)/2]*
         Gamma[4 + d]) + 
       ((128 - d*(3 + d)*(96 + d*(-24 + (-3 + d)*d*(6 + 5*d))))*Csc[d*Pi]*
         Gamma[-2 + d/2])/(Gamma[-(d/2)]*Gamma[(5 + d)/2]*
         Gamma[1 + (3*d)/2]))*prop[ks[LI[cc]]^2]^(3 - d)*
      (k[LI[cc], j3]*k[LI[cc], j4]*(\[Delta][j1, i2]*\[Delta][j2, i1] + 
         \[Delta][j1, i1]*\[Delta][j2, i2]) + k[LI[cc], j2]*
        (k[LI[cc], j4]*(\[Delta][j1, i2]*\[Delta][j3, i1] + 
           \[Delta][j1, i1]*\[Delta][j3, i2]) + k[LI[cc], j3]*
          (\[Delta][j1, i2]*\[Delta][j4, i1] + \[Delta][j1, i1]*
     ...
     (k[LI[cc], i2]*(k[LI[cc], j2]*k[LI[cc], j3]*k[LI[cc], j4]*
      ...
      (4*Pi^2*Cot[(d*Pi)/2]*Gamma[-2^(-1) - d/2] + 
       (2^(6 + d)*(-8 + d^2)*Pi^(7/2))/((8 - 6*d + d^2)*(-1 + Cos[d*Pi])*
         Gamma[-1 - d/2]*Gamma[4 + d]) + 
       (2^d*d*(32 + d*(32 + d*(86 + d*(-49 + 5*(-2 + d)*d))))*Pi^(5/2)*
         Csc[d*Pi]*Gamma[-2 + d/2])/((1 + d)*(3 + d)*Gamma[3 - d/2]*
    ...
    (2^(-5 - 3*d)*Pi^(5/2 - d)*Csc[(d*Pi)/2]*
      ((256*Pi*Csc[(d*Pi)/2]^2)/(Gamma[-2 - d/2]*Gamma[(-1 + d)/2]*
       ...
       ((128 - d*(3 + d)*(96 + d*(-24 + (-3 + d)*d*(6 + 5*d))))*Csc[d*Pi]*
         Gamma[-2 + d/2])/(Gamma[-(d/2)]*Gamma[(5 + d)/2]*
         Gamma[1 + (3*d)/2]))*prop[(-ks[LI[cc]])^2]^(3 - d)*
      ((-k[p[cc], j3])*(-k[p[cc], j4])*(\[Delta][j1, i2]*\[Delta][j2, i1] + 
         \[Delta][j1, i1]*\[Delta][j2, i2]) + (-k[p[cc], j2])*
        ((-k[p[cc], j4])*(\[Delta][j1, i2]*\[Delta][j3, i1] + 
           \[Delta][j1, i1]*\[Delta][j3, i2]) + (-k[p[cc], j3])*
          (\[Delta][j1, i2]*\[Delta][j4, i1] + \[Delta][j1, i1]*
